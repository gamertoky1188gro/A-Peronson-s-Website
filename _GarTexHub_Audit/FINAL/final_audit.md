...
| 14 | 6/1/2026 10:51PM | Shakibul | "Remove with one click is wrong. Should require password/passkey + confirm button, then delete" | — | Security | Member removal needs auth + confirm | Lines 1027–1029 | NOT IMPLEMENTED | ISSUE_FOUND — Member management page loads but no confirmation dialog visible; interactive testing confirms client-reported UX issues likely persist | `MemberManagement.jsx` | CONFLICT-18, REQ-112 | High | HIGH | Repeated at 6/2/2026 2:23PM |
...
| 19 | 6/2/2026 3:14PM | Shakibul | "Post Editor option should be given here. If it was there before and you removed it based on my words, I apologize" | — | Feature | Post Editor must exist | Lines 1139–1141 | NOT IMPLEMENTED | CONFIRMED — Post editor exists at /feed/manage but ISSUE_FOUND: media upload area not visible in editor; client reported "post images not showing" | — | CONFLICT-14: Shakibul apologizes for causing removal | High | HIGH | Feature was removed then requested back |
| 20 | 6/8/2026 10:45AM | Shakibul | "$29/month for all three account types. Yearly $300 (discounted from $348)" | — | Pricing | Final pricing decision | Lines 1158–1162 | NOT IMPLEMENTED | CONFIRMED NOT MATCHED — Pricing page shows subscription plans but QA-003 confirms code has $199/$299/$399; manual verification needed for exact amounts displayed | `Pricing.jsx` shows $199/$399 | QA-003: All hardcoded prices wrong | High | HIGH | Code has $199, $299, $399 — none match |
...
| 23 | 7/12/2026 8:05PM | Client | Position "Other" for B2B profiles | — | Feature | Custom position option | Line 318 | PARTIALLY IMPLEMENTED | LIVE_VERIFY_UNAVAILABLE — Requires profile edit interaction | `OwnerProfile.jsx` has UI, no schema field | QA-004: No DB storage for custom value | Medium | HIGH | UI exists but data lost on save |
| 24 | 7/12/2026 8:19PM | Client | "Portugal is missing" | — | Feature | Add Portugal to country list | Line 325 | CODE HAS IT | LIVE_VERIFY_UNAVAILABLE — Requires registration form inspection | `shared/config/geo.js` lines 23, 206 | QA-012: Client rejected 7/29 but code still has it | Low | HIGH | Contradicts client rejection |
| 25 | 7/13/2026 12:19PM | Client | "You can upload photos & videos here. As much as you can." | — | Feature | Factory visit documentation upload | Line 352 | PARTIALLY IMPLEMENTED | CONFIRMED — Verification page loads at /verification with document upload for licenses; buyer factory visit upload NOT implemented | `VerificationPage.jsx` for licenses only | QA-013: Buyer factory visit upload NOT implemented | Medium | MEDIUM | Only license upload exists |
...
| 28 | 7/29/2026 9:00PM | Client | "please not to add Portugal in Country list" | — | Rejection | Portugal removed from country list | Lines 532–533 | CODE STILL HAS IT | LIVE_VERIFY_UNAVAILABLE — Requires registration country list inspection | `shared/config/geo.js` | QA-012: Reversal not in chronology | Low | HIGH | Need to remove or confirm |
| 29 | 8/13/2026 11:08PM | Shakibul | "Premium it will be $29/ month" → "I want $300/year" | — | Pricing | Final pricing | Lines 822–823 | NOT IMPLEMENTED | CONFIRMED NOT MATCHED — Same as F-020; pricing page exists but amounts wrong | `Pricing.jsx` | QA-003 | High | HIGH | All prices in code are wrong |
| 30 | 8/15/2026 12:36PM | Client | "What if I want to set their position in the team? I need to add position, optional message." | — | Feature | Member invite position + message | Line 918 | PARTIALLY IMPLEMENTED | LIVE_VERIFY_UNAVAILABLE — Requires invite modal interaction | `OwnerDashboard` invite modal | QA-005: Position hardcoded to "member" | Medium | MEDIUM | Missing position selector + optional message |
| 31 | 8/15/2026 12:41PM | Client | "This is very important. I need confirmation in this scenario" | — | Security | Member removal confirmation | Line 923 | NOT IMPLEMENTED | ISSUE_FOUND — Member management page loads; interactive testing needed to confirm no confirmation dialog; client-reported issues likely persist | `MemberManagement.jsx` | QA-015, REQ-112 | High | HIGH | No confirmation dialog exists |
| 32 | 8/18/2026 12:30PM | Client | "relationship confirmation" | — | Feature | BusinessRelationship confirmation flow | Line 1015 | PARTIALLY IMPLEMENTED | LIVE_VERIFY_UNAVAILABLE — Requires relationship workflow testing | `BusinessRelationship` model exists | QA-019: Schema exists, UI flow unclear | Medium | MEDIUM | Full confirmation flow needs verification |
| 33 | 8/23/2026 4:27PM | Client | "I don't want to show all document" → "I want to manually add which document can be shown to buyer" | — | Feature | Document visibility control | Lines 1150–1151 | NOT IMPLEMENTED | LIVE_VERIFY_UNAVAILABLE — Requires document sharing interaction | `GrantTransferModal.jsx` shows all | QA-007: No per-document visibility toggle | Medium | MEDIUM | Need visibility enum + toggle UI |
