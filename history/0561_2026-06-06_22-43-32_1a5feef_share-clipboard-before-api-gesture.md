...
Reorders the share handler in MainFeed to copy the URL to clipboard _before_ making the async API call, ensuring the clipboard write is triggered by the user gesture (click).
