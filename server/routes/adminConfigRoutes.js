...
router.get("/config", requireAuth, requireAdminSecurity, async (req, res) => {
  try {
    const config = await getAllConfig();
    res.json(config);
  } catch (error) {
    console.error(chalk.red("[AdminConfig] GET /config error:", error.message));
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/inventory error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] GET /config/inventory/:moduleId error:",
        error.message,
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/inventory error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/actions error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] GET /config/actions/groups error:",
        error.message,
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/actions error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] GET /config/capabilities error:",
        error.message,
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] PUT /config/capabilities error:",
        error.message,
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/ui error:", error.message),
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/ui error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/mock error:", error.message),
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/mock error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/roles error:", error.message),
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/roles error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/governance error:", error.message),
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/governance error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/branding error:", error.message),
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/branding error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/security error:", error.message),
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] PUT /config/security error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/history error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/roles-list error:", error.message),
      );
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] GET /config/infra-capabilities error:",
        error.message,
      );
      res.status(500).json({ error: "Failed to fetch capabilities" });
    }
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] GET /config/network-capabilities error:",
        error.message,
      );
      res.status(500).json({ error: "Failed to fetch capabilities" });
    }
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] GET /config/ultra-capabilities error:",
        error.message,
      );
      res.status(500).json({ error: "Failed to fetch capabilities" });
    }
...
router.get(
  ...
  async (req, res) => {
    try {
      const [inventory, ui, roles, infraCaps, networkCaps, ultraCaps, actions] =
        await Promise.all([
          getInventoryWithFallback(),
          getUiConfigWithFallback(),
          getRoleConfigWithFallback(),
      ...
      console.error(
        "[AdminConfig] GET /config/total-config error:",
        error.message,
      );
      res.status(500).json({ error: "Failed to fetch config" });
    }
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        chalk.red("[AdminConfig] GET /config/feed-page error:", error.message),
      );
...
router.patch(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "[AdminConfig] PATCH /config/feed-page error:",
        error.message,
      );
  ...
  try {
    ...
    if (action === "feed_page_config.update") {
      ...
      if (updates.stats_buyer_requests)
        config.feed_page.labels.stats.buyer_requests =
          updates.stats_buyer_requests;
      if (updates.stats_company_products)
        config.feed_page.labels.stats.company_products =
          updates.stats_company_products;
      ...
      if (updates.messages_report_submitted)
        config.feed_page.messages.report_submitted =
          updates.messages_report_submitted;
      if (updates.messages_interest_expressed)
        config.feed_page.messages.interest_expressed =
          updates.messages_interest_expressed;
      ...
      if (updates.messages_all_caught_up)
        config.feed_page.messages.all_caught_up =
          updates.messages_all_caught_up;
    ...
    console.error(
      chalk.red("[AdminConfig] POST /actions error:", error.message),
    );
