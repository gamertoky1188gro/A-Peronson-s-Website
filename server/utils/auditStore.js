...
const AUDIT_PATH = path.join(process.cwd(), 'server', 'database', 'admin_audit.json')
...
export function sanitizeAuditPayload(payload = {}) {
  const redactedKeys = new Set(['password', 'new_password', 'token', 'authorization', 'jwt', 'secret'])
