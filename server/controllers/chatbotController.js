import { getChatbotProfileSummary, getChatbotSettings, maybeGenerateBotReply, updateChatbotSettings } from '../services/chatbotService.js'
...
export async function getChatbotSettingsController(req, res) {
  await ensureEntitlement(req.user, 'ai_auto_reply_customization', 'Premium plan required for AI auto-reply customization.')
