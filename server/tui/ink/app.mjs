...
const barrier = (w, color) => /*#__PURE__*/_jsx(Text, {
  color: color,
  children: "─".repeat(Math.max(0, w))
});
...
const hitTest = g => {
  ...
  if (y === 1) {
    ...
    if (x >= x0 && x < x0 + (g.rec ? 10 : 7)) return {
      type: "top",
      index: 0
    };
    if (x >= x1 && x < x1 + (g.paused ? 11 : 9)) return {
      type: "top",
      index: 1
    };
    if (x >= x2 && x < x2 + 9) return {
      type: "top",
      index: 2
    };
    if (x >= x3 && x < x3 + 8) return {
      type: "top",
      index: 3
    };
    return null;
  ...
  if (x >= inspLeft && x <= columns - 1 && columns >= 96) {
    if (y === mainTop) {
      ...
      for (let i = 0; i < 4; i++) {
        ...
        if (x >= tLeft && x <= tLeft + tabW - 1) return {
          type: "tab",
          index: i
        };
      }
    }
    if (y >= mainTop + 1) return {
      type: "toast",
      msg: g.inspectorInfo
    };
    return null;
  ...
  if (x >= logareaLeft && x <= logareaRight && y >= logareaTop && y <= logareaTop + height - 1) {
    if (y === logareaTop + 1) {
      if (x <= logareaRight - 21) return {
        type: "search"
      };
      if (x <= logareaRight - 11) return {
        type: "search"
      };
      return {
        type: "export"
  ...
  if (showBottom && y >= bottomTop && y <= bottomTop + 5) {
    ...
    if (card === 2) {
      if (y === bottomTop + 2 && x <= mainColLeft + 2 * (cardW + 1) + cardW / 2) return {
        type: "record",
        windowMs: 1_800_000
      };
      if (y === bottomTop + 2) return {
        type: "record",
        windowMs: 3_600_000
      };
      return {
  ...
  if (y >= mainTop && y <= mainTop + 4) return {
    type: "toast",
    msg: g.overviewInfo
  };
  return null;
};
const HEAT_COLORS = ["#19243d", "#1f2b4d", "#27345b", "#35406b", "#4b3f79", "#5f3f88", "#7c3fa0", "#93409e", "#b14f9e", "#c35598", "#e06b8b", "#f4827c"];
const Chip = ({
  label,
  on
}) => /*#__PURE__*/_jsx(Box, {
...
const TopBar = ({
  ...
  children: [/*#__PURE__*/_jsx(Box, {
    ...
    children: [/*#__PURE__*/_jsx(Text, {
      ...
      color: C.muted,
      children: " SERVER LOG OBSERVATORY"
    })]
  }), /*#__PURE__*/_jsxs(Text, {
    ...
    wrap: "truncate-end",
    children: [/*#__PURE__*/_jsx(Text, {
      color: connected ? C.green : C.pink,
      children: "\u25CF"
    ...
    children: [/*#__PURE__*/_jsx(TextButton, {
      label: rec ? "● REC ON" : "● REC",
      active: rec
    }), /*#__PURE__*/_jsx(TextButton, {
      label: paused ? "▶ Resume" : "Ⅱ Pause",
      active: paused
    }), /*#__PURE__*/_jsx(TextButton, {
      label: "\u2304 Follow",
      active: following
...
const NavItem = ({
  ...
  return /*#__PURE__*/_jsx(Box, {
    paddingX: 1,
    backgroundColor: active ? "#1b2541" : undefined,
    children: /*#__PURE__*/_jsxs(Text, {
      wrap: "truncate-end",
      children: [active ? /*#__PURE__*/_jsx(Text, {
        color: C.violet,
        children: "\u258D"
      }) : null, /*#__PURE__*/_jsxs(Text, {
        color: active ? C.violet : "#9da9c6",
        children: [icon, " ", pad(label, badge === undefined ? 12 : 9)]
      }), /*#__PURE__*/_jsx(Text, {
        color: hot ? C.pink : "#aeb9d4",
        bold: true,
        children: badgeStr
      })]
    })
...
const Sidebar = ({
  ...
  children: [/*#__PURE__*/_jsx(Text, {
    ...
    wrap: "truncate-end",
    children: "WORKSPACE"
  }), WORKSPACE.map(it => /*#__PURE__*/_jsx(NavItem, {
    icon: it.icon,
    label: it.label,
    badge: counts[it.key],
    active: view === it.key
  }, it.key)), /*#__PURE__*/_jsx(Text, {
    color: C.muted2,
    bold: true,
    wrap: "truncate-end",
    marginTop: 1,
    children: "SERVICES"
  }), SERVICES.map(it => /*#__PURE__*/_jsx(NavItem, {
    icon: it.icon,
    label: it.label,
    badge: it.key === "favorites" ? bookmarkedCount : categoryCounts[it.key],
    hot: it.hot,
    active: view === it.key
  }, it.key)), /*#__PURE__*/_jsxs(Box, {
    borderStyle: "single",
    borderColor: C.border,
    paddingX: 1,
    flexDirection: "column",
    ...
    children: [/*#__PURE__*/_jsx(Text, {
      ...
      color: C.text,
      wrap: "truncate-end",
      children: "WORKSPACE \xB7 production"
    }), /*#__PURE__*/_jsx(Text, {
      color: C.muted,
      wrap: "truncate-end",
      children: footerInfo
...
const Bar = ({
  ...
  return /*#__PURE__*/_jsxs(Text, {
    children: [/*#__PURE__*/_jsx(Text, {
      color: C.violet,
      children: "█".repeat(half)
    }), /*#__PURE__*/_jsx(Text, {
      color: C.cyan,
      children: "█".repeat(Math.max(0, width - half))
    })]
  });
};
const Metric = ({
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsxs(Box, {
      ...
      children: [/*#__PURE__*/_jsx(Text, {
        ...
        bold: true,
        wrap: "truncate-end",
        children: "LIVE OBSERVABILITY"
      }), /*#__PURE__*/_jsx(Text, {
        color: C.text,
        bold: true,
        wrap: "truncate-end",
        children: "Backend / server logs"
      }), /*#__PURE__*/_jsx(Text, {
        color: C.muted,
        wrap: "truncate-end",
        children: "Canonical logger \xB7 request middleware \xB7 audit \xB7 RFC 5424 syslog \xB7 workers"
      })]
    }), roomy ? /*#__PURE__*/_jsxs(_Fragment, {
      children: [/*#__PURE__*/_jsx(Metric, {
        label: "INFO",
...
const Sparkline = ({
  ...
  if (!vals.length) return /*#__PURE__*/_jsx(Text, {
    color: color,
...
const SparkCard = ({
  ...
  children: [/*#__PURE__*/_jsx(Text, {
    ...
    color: C.muted,
    wrap: "truncate-end",
    children: "\xB7 last 60 sec"
  }), /*#__PURE__*/_jsx(Sparkline, {
    data: data,
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsx(Text, {
      ...
      children: [/*#__PURE__*/_jsx(Box, {
        flexDirection: "row",
        gap: 0,
        children: cells.slice(0, 12).map((v, i) => /*#__PURE__*/_jsx(Text, {
          color: HEAT_COLORS[Math.round(v * 11)],
          children: "\u2588"
        }, i))
      }), /*#__PURE__*/_jsx(Box, {
        flexDirection: "row",
        gap: 0,
        children: cells.slice(12).map((v, i) => /*#__PURE__*/_jsx(Text, {
          color: HEAT_COLORS[Math.round(v * 11)],
          children: "\u2588"
        }, i + 12))
      })]
...
const SessionCard = ({
  ...
  children: [/*#__PURE__*/_jsx(Text, {
    ...
    children: [/*#__PURE__*/_jsx(Text, {
      color: C.muted,
      children: "Recording state"
    }), /*#__PURE__*/_jsx(Text, {
      bold: true,
      color: rec ? C.pink : C.muted2,
      children: rec ? `REC · ${startedAt}` : "IDLE"
    })]
  })]
});
...
const LogRow = ({
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsxs(Box, {
      ...
      children: [/*#__PURE__*/_jsx(Text, {
        color: "#71809f",
        children: pad(log.ts, 12)
      }), /*#__PURE__*/_jsx(Text, {
        color: lvlColor,
        bold: true,
        children: pad(log.level, 9)
      }), /*#__PURE__*/_jsx(Text, {
        color: C.text,
        children: trunc(log.msg, msgW)
      }), tagW > 0 && /*#__PURE__*/_jsx(Box, {
        marginLeft: "auto",
        children: /*#__PURE__*/_jsxs(Text, {
          color: C.muted2,
          children: [" ", trunc(log.tags.join(" · "), tagW)]
        })
      })]
    }), selected && /*#__PURE__*/_jsxs(Box, {
      flexDirection: "row",
      backgroundColor: bg,
      paddingX: 1,
      children: [/*#__PURE__*/_jsx(Text, {
        color: C.muted,
        children: pad(trunc(log.src, 12), 12)
      }), /*#__PURE__*/_jsx(Text, {
        color: C.muted2,
        children: trunc(log.src.slice(12) || "source", Math.max(1, mainWidth - 13))
      })]
    })]
  });
};
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsxs(Box, {
      ...
      children: [/*#__PURE__*/_jsxs(Box, {
        ...
        paddingX: 1,
        children: [searchActive ? /*#__PURE__*/_jsx(TextInput, {
          value: search,
          onChange: v => onSearchChange(stripMouseSgr(v)),
          placeholder: "Search logs\u2026 (Enter = server query)",
          showCursor: true
        }) : /*#__PURE__*/_jsxs(Text, {
          color: search ? C.text : C.muted,
          children: ["\u2315", " ", trunc(search || "Search logs: error · redis · user:24 · regex:/…/ · 5m — press /", Math.max(10, width - 40))]
        }), /*#__PURE__*/_jsx(Text, {
          color: "#697694",
          children: " /"
        })]
      ...
      alignItems: "center",
      flexShrink: 0,
      children: [LEVELS.map(l => /*#__PURE__*/_jsx(Chip, {
        label: l,
        on: enabled.has(l)
      }, l)), /*#__PURE__*/_jsx(Box, {
        marginLeft: "auto",
        children: /*#__PURE__*/_jsx(Text, {
          color: C.muted2,
          children: queryResult ? `☷ SERVER SEARCH ${filtered.length}` : paused ? "Ⅱ PAUSED" : "● LIVE"
        })
      })]
    }), /*#__PURE__*/_jsxs(Box, {
      flexDirection: "column",
      flexGrow: 1,
      minHeight: 0,
      children: [window.length === 0 && /*#__PURE__*/_jsx(Text, {
        color: C.muted,
        paddingLeft: 1,
        children: "No logs match the current filter."
      }), window.map(l => /*#__PURE__*/_jsx(LogRow, {
        log: l,
...
const JsonBlock = ({
  ...
  children: Object.entries(obj || {}).map(([k, v]) => {
    ...
    return /*#__PURE__*/_jsxs(Text, {
      children: ["  ".repeat(indent), /*#__PURE__*/_jsx(Text, {
        color: C.purple,
        children: k
      }), /*#__PURE__*/_jsx(Text, {
        color: "#aeb9d4",
...
const FlowView = ({
  ...
  if (!requestId) {
    return /*#__PURE__*/_jsx(Text, {
      color: C.muted2,
      children: "No request_id on this event \u2014 flow unavailable."
    });
  }
  if (!(flow && flow.length)) {
    return /*#__PURE__*/_jsxs(Text, {
      color: C.muted2,
      children: ["Fetching request flow for ", shortId(requestId), "\u2026 (no steps recorded yet)"]
    });
  }
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsxs(Text, {
      wrap: "truncate-end",
      children: [sorted.map((s, i) => /*#__PURE__*/_jsxs(Text, {
        children: [/*#__PURE__*/_jsx(Text, {
          color: C.violet,
          children: i ? " › " : ""
        }), /*#__PURE__*/_jsx(Text, {
          color: C.text,
          children: trunc(s.message || s.category || "step", 22)
        })]
      }, s.id)), /*#__PURE__*/_jsx(Text, {
        color: C.violet,
        children: " \u203A "
      }), /*#__PURE__*/_jsxs(Text, {
        bold: true,
      ...
      return /*#__PURE__*/_jsxs(Text, {
        children: [/*#__PURE__*/_jsxs(Text, {
          ...
          color: LEVEL_COLOR[s.level?.toUpperCase()] || C.text,
          children: "\u25CF"
        }), " ", /*#__PURE__*/_jsx(Text, {
          color: C.text,
          children: trunc(s.message || s.category || "?", 30)
        }), /*#__PURE__*/_jsxs(Text, {
          color: C.muted2,
          children: [" ", Number.isFinite(dur) ? `${Math.round(dur)}ms` : ""]
        })]
      }, s.id);
    })]
  });
...
const Inspector = ({
  ...
  const kv = (label, value, color) => /*#__PURE__*/_jsxs(Box, {
    flexDirection: "row",
    gap: 1,
    children: [/*#__PURE__*/_jsx(Text, {
      color: "#687694",
      children: pad(label + ":", 10)
    }), /*#__PURE__*/_jsx(Text, {
      color: color || "#d6def2",
      wrap: "truncate-end",
      children: value
  ...
  const divider = () => /*#__PURE__*/_jsx(Text, {
    color: "#263250",
    children: "─".repeat(Math.max(4, width - 4))
  });
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsx(Box, {
      ...
      children: /*#__PURE__*/_jsx(Text, {
        wrap: "truncate-end",
        children: TABS.map((t, i) => /*#__PURE__*/_jsx(Text, {
          backgroundColor: i === tab ? "#202b48" : undefined,
          color: i === tab ? C.text : "#71809f",
          bold: i === tab,
          children: (i ? " " : "") + center(t, tabW)
        }, t))
      })
    }), /*#__PURE__*/_jsxs(Box, {
      flexDirection: "column",
      ...
      padding: 1,
      flexGrow: 1,
      children: [tab === 0 && /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsxs(Box, {
          flexDirection: "row",
          justifyContent: "space-between",
          children: [/*#__PURE__*/_jsxs(Text, {
            color: LEVEL_COLOR[log.level] || C.text,
            bold: true,
            children: [log.level, " \xB7 Event Inspector"]
          }), /*#__PURE__*/_jsxs(Text, {
            color: C.cyan,
            children: ["#", shortId(log.id)]
          })]
        }), divider(), kv("Timestamp", log.ts), kv("Source", log.src, C.cyan), kv("Message", log.msg), kv("Subsystem", log.category), kv("Request", log.requestId ? shortId(log.requestId) : "—"), kv("Repeats", log.groupCount > 1 ? `×${log.groupCount}` : "—"), divider(), /*#__PURE__*/_jsx(Text, {
          bold: true,
          color: C.text,
          children: "Request Flow"
        }), /*#__PURE__*/_jsx(FlowView, {
          flow: flow,
          requestId: log.requestId
        }), divider(), /*#__PURE__*/_jsx(Text, {
          bold: true,
          color: C.text,
          children: "Payload"
        }), /*#__PURE__*/_jsx(JsonBlock, {
          obj: log.meta
        })]
      }), tab === 1 && /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsxs(Box, {
          flexDirection: "row",
          justifyContent: "space-between",
          children: [/*#__PURE__*/_jsx(Text, {
        ...
        }), divider(), /*#__PURE__*/_jsx(JsonBlock, {
          obj: {
            id: log.id,
            timestamp: log.ts,
            level: log.level,
      ...
      }), tab === 2 && /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsxs(Box, {
          flexDirection: "row",
          justifyContent: "space-between",
          children: [/*#__PURE__*/_jsx(Text, {
        ...
        }), divider(), stackLines.length ? stackLines.slice(0, 14).map((f, i) => /*#__PURE__*/_jsxs(Text, {
          color: "#9ca8c4",
          children: [/*#__PURE__*/_jsx(Text, {
            color: "#3b496b",
            children: "\u2193 "
          ...
          color: C.muted2,
          children: "No stack trace captured for this event."
        })]
      }), tab === 3 && /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsxs(Box, {
          flexDirection: "row",
          justifyContent: "space-between",
          children: [/*#__PURE__*/_jsx(Text, {
        ...
        }), divider(), /*#__PURE__*/_jsxs(Text, {
          color: C.muted,
          children: ["[", log.ts, "] [", log.level, "] [", log.category, "] ", log.msg]
        }), /*#__PURE__*/_jsxs(Text, {
          color: C.muted,
          children: ["source=", log.src]
        }), /*#__PURE__*/_jsxs(Text, {
          color: C.muted,
          children: ["host=", log.raw?.host, " pid=", log.raw?.pid]
        }), /*#__PURE__*/_jsxs(Text, {
          color: C.muted,
          children: ["request_id=", log.requestId || "—"]
        }), /*#__PURE__*/_jsxs(Text, {
          color: C.muted,
          children: ["payload=", JSON.stringify(log.meta)]
        })]
      })]
    })]
  });
...
const StatusBar = ({
  ...
  const primary = [/*#__PURE__*/_jsxs(Text, {
    color: paused ? C.amber : C.green,
    bold: true,
    children: ["\u25CF ", paused ? "PAUSED" : "LIVE"]
  }, "live"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["logs/sec ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.rate ?? 0
    })]
  }, "rate"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["req/s ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.reqRate ?? 0
    })]
  }, "rps"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["CPU ", /*#__PURE__*/_jsxs(Text, {
      color: "#dce5ff",
      children: [cpu, "%"]
    })]
  }, "cpu"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["RAM ", /*#__PURE__*/_jsxs(Text, {
      color: "#dce5ff",
      children: [ram, " GB"]
    })]
  }, "ram"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Redis", " ", /*#__PURE__*/_jsxs(Text, {
      color: isRedisOk(stats?.redis) ? C.green : C.pink,
      children: ["\u25CF ", isRedisOk(stats?.redis) ? "Connected" : "Down"]
    })]
  }, "redis"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Queue ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.workQ ?? 0
    })]
  }, "q"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Workers ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.workers ?? 0
    })]
  }, "w")];
  const secondary = [/*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Latency ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: fmtMs(stats?.avgLatency)
    })]
  }, "lat"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["p95 ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: fmtMs(stats?.p95)
    })]
  }, "p95"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Dropped ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.dropped ?? 0
    })]
  }, "drop"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Filtered ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.filtered ?? 0
    })]
  }, "filt"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Regex ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: stats?.regexHits ? stats.regexHits : "OFF"
    })]
  }, "rx"), /*#__PURE__*/_jsxs(Text, {
    color: C.muted,
    children: ["Uptime ", /*#__PURE__*/_jsx(Text, {
      color: "#dce5ff",
      children: fmtUptime(stats?.uptime)
    })]
  }, "up")];
  return /*#__PURE__*/_jsxs(Box, {
    flexDirection: "row",
    ...
    paddingX: 1,
    alignItems: "center",
    children: [primary, width >= 144 && secondary, width >= 205 && /*#__PURE__*/_jsx(Box, {
      marginLeft: "auto",
      children: /*#__PURE__*/_jsx(Text, {
        color: C.muted2,
        children: "/ Search \xB7 Space Pause \xB7 F Follow \xB7 J/K Navigate \xB7 Enter Inspect \xB7 B Bookmark \xB7 R Record \xB7 E Export \xB7 1-6 Chips"
      })
    })]
  });
};
...
const Toast = ({
  ...
  children: [/*#__PURE__*/_jsxs(Text, {
    ...
    color: C.muted,
    children: ["NEON", "//", "OBSERVE \xB7 live stream"]
  })]
});
const Modal = ({
  log,
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsxs(Text, {
      bold: true,
      color: LEVEL_COLOR[log.level] || C.text,
      children: [log.level, " \xB7 ", trunc(log.msg, 50)]
    }), /*#__PURE__*/_jsxs(Text, {
      color: C.muted,
      children: [log.ts, " \xB7 ", log.src]
    }), /*#__PURE__*/_jsx(Text, {
      color: "#263250",
      children: "─".repeat(mw - 4)
    }), /*#__PURE__*/_jsxs(Box, {
      flexDirection: "column",
      children: [/*#__PURE__*/_jsx(Text, {
        bold: true,
    ...
    }), stackLines.length > 0 && /*#__PURE__*/_jsxs(Box, {
      flexDirection: "column",
      children: [/*#__PURE__*/_jsx(Text, {
        bold: true,
        color: C.text,
        children: "Stack Trace"
      }), stackLines.slice(0, 8).map((f, i) => /*#__PURE__*/_jsxs(Text, {
        color: "#9ca8c4",
        children: ["\u2193 ", trunc(f, mw - 6)]
      }, i))]
    }), /*#__PURE__*/_jsx(Text, {
      color: C.muted2,
      children: "ESC close \xB7 J/K navigate \xB7 B bookmark"
    })]
  });
};
const useSysInfo = () => {
  ...
  useEffect(() => {
    const sample = () => {
      ...
      setSys({
        cpu,
        ram: Math.round((os.totalmem() - os.freemem()) / 1_073_741_824 * 10) / 10
      });
    };
    sample();
...
const NeonObserveApp = ({
  ...
  useEffect(() => {
    ...
    process.stderr.write("[probe] ws effect mount\n");
    client.on("connected", () => {
      setConnected(true);
    ...
    client.on("burst", b => toast(b.summary || `${b.total || 0} errors detected in burst window`));
    ...
    client.on("bookmark_ok", m => {
      setBookmarks(prev => {
        ...
        if (m.bookmarked) next.add(m.id);else next.delete(m.id);
        return next;
      });
    ...
    client.connect();
    return () => {
      process.stderr.write("[probe] ws effect cleanup\n");
      client.close();
  ...
  const filtered = useMemo(() => {
    ...
    return list.filter(e => enabled.has(e.level) && viewOk(e, view) && (!q || `${e.msg} ${e.src} ${e.category} ${e.level}`.toLowerCase().includes(q)));
  ...
  const cleanWindow = visibleWindow.some(l => l.id === selectedId) && visibleWindow.length > 1 ? visibleWindow.slice(0, -1) : visibleWindow;
  const move = delta => {
    ...
    setSelectedId(e.id);
    setScrollOffset(Math.max(0, Math.min(next - Math.floor(visible / 2), Math.max(0, filtered.length - visible))));
  ...
  const doExport = () => {
    fetch(`http://localhost:${apiPort}/api/logs/export`).then(r => r.text()).then(t => toast(`exported ${t.trim().split("\n").length} log lines`)).catch(() => toast("export failed — server unreachable"));
  };
  const doRecord = windowMs => {
    ...
    clientRef.current?.recordStart(windowMs ? {
      windowMs
    } : {});
    setRec(true);
    toast(windowMs ? `recording session (${Math.round(windowMs / 60_000)} min)` : "recording session");
  };
  const selected = filtered.find(l => l.id === selectedId) || filtered[filtered.length - 1] || null;
  const geoRef = useRef({});
  geoRef.current = {
    columns,
    rows,
  ...
  useEffect(() => {
    ...
    const onData = chunk => {
      ...
      while ((m = SGR_SCAN_RE.exec(buf)) !== null) {
        ...
        if (e.scroll) {
          setScrollOffset(o => Math.max(0, Math.min(o + e.scroll, Math.max(0, g.filteredCount - g.visible))));
          continue;
        }
  ...
  const applyTarget = t => {
    ...
    switch (t.type) {
      case "nav":
        if (t.section === 0) setViewFilter(WORKSPACE[t.index].key);else setViewFilter(SERVICES[t.index].key);
        break;
      case "chip":
        toggleChip(t.level);
        break;
      ...
      case "log":
        ...
        break;
      case "top":
        if (t.index === 0) doRecord(0);else if (t.index === 1) togglePause(!paused);else if (t.index === 2) setFollowing(f => !f);else if (t.index === 3) setGlow(g => !g);
        break;
      case "record":
        doRecord(t.windowMs);
        break;
  ...
  useInput((input, key) => {
    ...
    if (modalId !== null) {
      if (key.escape || key.return) setModalId(null);else if (input === "j" || key.downArrow) move(1);else if (input === "k" || key.upArrow) move(-1);else if (input === "b") clientRef.current?.bookmark(selected?.id);
      return;
    }
    if (input === "/") {
      setSearchActive(true);
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsx(TopBar, {
      ...
      glow: glow,
      connected: connected,
      serverInfo: clientRef.current?.url ? trunc(clientRef.current.url.replace("ws://", "").replace("/ws/logs", ""), 14) : ""
      ...
      height: mainRowH,
      flexShrink: 0,
      children: [columns >= 84 && /*#__PURE__*/_jsx(Sidebar, {
        width: sidebarW,
        view: view,
        counts: counts,
        ...
        children: [/*#__PURE__*/_jsx(Overview, {
          ...
          height: 1
        }), showBottom && /*#__PURE__*/_jsxs(Box, {
          flexDirection: "row",
          gap: 1,
          flexShrink: 0,
          width: mainW,
          height: 6,
          children: [/*#__PURE__*/_jsx(SparkCard, {
            data: stats?.lastRates || [],
            width: cardW
          }), /*#__PURE__*/_jsx(HeatCard, {
            buckets: heatmap?.buckets,
            width: cardW
          }), /*#__PURE__*/_jsx(SessionCard, {
            width: cardW,
            rec: rec,
      ...
      }), columns >= 96 && /*#__PURE__*/_jsx(Inspector, {
        width: inspW,
      ...
      cpu: sys.cpu,
      ram: sys.ram
    }), toastMsg && /*#__PURE__*/_jsx(Toast, {
      msg: toastMsg
    }), modalId !== null && /*#__PURE__*/_jsx(Modal, {
