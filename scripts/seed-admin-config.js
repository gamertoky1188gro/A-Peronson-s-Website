		...
		sections: [
			{
				...
				features: ["Interface health", "Packet loss", "Latency heatmap", "Topology map"],
			},
			{
				id: "config",
				title: "Configuration",
				features: ["Device templates", "Change pushes", "Versioned config", "Rollback safety"],
			},
		],
	},
	{
	...
	},
	{
		...
		sections: [
			...
			},
			{
				id: "ui",
				title: "UI Settings",
				features: ["Manage chart palette", "Manage empty states", "Manage section metrics"],
			},
		],
	},
];
...
const ROLE_CONFIG_DATA = [
	{
		...
		label: "Buyer",
		is_admin_role: false,
		benefits: ["Access to factory network", "Request quotations", "Track orders"],
	},
	{
		role_key: "factory",
		label: "Factory",
	...
	},
	{
		...
		label: "Buying House",
		is_admin_role: false,
		benefits: ["Manage multiple buyers", "Commission tracking", "Supplier network"],
	},
	{
		role_key: "owner",
	...
	},
	{
		...
		label: "Admin",
		is_admin_role: true,
		benefits: ["Platform administration", "User management", "Analytics access"],
	},
	{
		role_key: "agent",
		label: "Agent",
		is_admin_role: false,
		benefits: ["Lead management", "Client communication", "Commission tracking"],
	},
];
