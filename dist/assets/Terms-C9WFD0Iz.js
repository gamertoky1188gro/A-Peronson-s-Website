...
import { u as k } from "./usePageMeta-Bj0pssG4.js";
import { C as x } from "./circle-alert-bLNAqvIG.js";
import { F as v } from "./file-pen-line-DYaqzfFe.js";
import { R as w } from "./radio-tower-AxDC8n2j.js";
import { S as j } from "./sparkles-DVBGTjg1.js";
import { L as N } from "./lock-keyhole-C0HeDHeq.js";
import { B as _ } from "./badge-info-9rvP24vr.js";
/**
...
function M({ section: a, index: n, visible: r }) {
  const l = a.icon;
  return e.jsxs("article", {
    ...
    className: [
      ...
      r ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0",
    ].join(" "),
    style: { transitionDelay: `${Math.min(n * 90, 720)}ms` },
    children: [
      e.jsx("div", {
        className:
          "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(56,189,248,0.14),transparent_42%),radial-gradient(circle_at_bottom_left,rgba(14,165,233,0.10),transparent_38%)]",
      }),
      e.jsxs("div", {
        ...
        children: [
          e.jsx("div", {
            className:
              "flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-sky-200 bg-gradient-to-br from-sky-500 to-cyan-400 text-white shadow-lg shadow-sky-500/20 dark:border-sky-900/50",
            children: e.jsx(l, { className: "h-7 w-7" }),
          }),
          e.jsxs("div", {
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("span", {
                    className:
                      "inline-flex items-center rounded-full border border-sky-200 bg-sky-50 px-3 py-1 text-xs font-semibold tracking-[0.18em] text-sky-700 dark:border-sky-900/60 dark:bg-sky-950/70 dark:text-sky-300",
                    children: a.index,
                  }),
                  e.jsx("span", {
                    className:
              ...
              e.jsx("div", {
                className:
                  "mt-5 space-y-3 text-[15px] leading-7 text-slate-600 dark:text-slate-300",
                children: a.bullets.map((t) =>
                  e.jsxs(
                    "div",
                    {
                      className:
                        "flex gap-3 rounded-2xl border border-slate-200/70 bg-white/70 px-4 py-3 dark:border-slate-800/70 dark:bg-slate-900/50",
                      children: [
                        e.jsx(f, {
              ...
              a.alert
                ? e.jsxs("div", {
                    className:
                      "mt-5 rounded-2xl border border-amber-300/70 bg-amber-50 px-4 py-4 text-[15px] leading-7 text-amber-950 shadow-sm dark:border-amber-900/50 dark:bg-amber-950/20 dark:text-amber-100",
                    children: [
                      e.jsx("strong", {
                        className: "block text-amber-900 dark:text-amber-200",
                        children:
              ...
              a.process
                ? e.jsxs("div", {
                    className:
                      "mt-5 rounded-2xl border border-sky-200 bg-sky-50/80 p-4 dark:border-sky-900/60 dark:bg-sky-950/20",
                    children: [
                      e.jsx("div", {
                        className:
                          "mb-2 text-sm font-semibold uppercase tracking-[0.18em] text-sky-700 dark:text-sky-300",
                        children: "Process",
                      }),
                      e.jsx("div", {
                        className:
                          "space-y-2 text-[15px] leading-7 text-slate-700 dark:text-slate-200",
                        children: a.process.map((t) =>
                          e.jsxs(
                            "div",
                            {
      ...
      a.signatureMark
        ? e.jsx("div", {
            className:
              "relative mt-6 overflow-hidden rounded-3xl border border-sky-200/80 bg-gradient-to-br from-sky-50 via-cyan-50 to-white p-5 dark:border-sky-900/60 dark:from-sky-950/50 dark:via-cyan-950/30 dark:to-slate-950",
            children: e.jsx(S, {}),
          })
        : null,
    ],
...
function D() {
  ...
  const [a, n] = i.useState(() => u.map((t, s) => s < 2)),
    r = i.useRef([]),
    l = i.useMemo(
      () =>
      ...
      const t = new IntersectionObserver(
        (s) => {
          n((o) => {
            const d = [...o];
            for (const c of s) {
              const m = r.current.findIndex((h) => h === c.target);
              m !== -1 && c.isIntersecting && (d[m] = !0);
            }
            return d;
          });
        },
        { root: null, threshold: 0.08, rootMargin: "-80px 0px -10% 0px" },
      );
      return (
        r.current.forEach((s) => s && t.observe(s)),
        () => t.disconnect()
      );
    }, []),
    e.jsxs("main", {
      className:
        "min-h-screen bg-[#f3f9ff] text-slate-900 dark:bg-[#07111f] dark:text-white",
      children: [
        e.jsx("div", {
          className:
            "absolute inset-x-0 top-0 -z-0 h-[520px] bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.22),transparent_40%),radial-gradient(circle_at_top_right,rgba(56,189,248,0.20),transparent_36%),linear-gradient(to_bottom,rgba(255,255,255,0.8),transparent)] dark:bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.24),transparent_38%),radial-gradient(circle_at_top_right,rgba(34,211,238,0.18),transparent_34%),linear-gradient(to_bottom,rgba(7,17,31,1),rgba(7,17,31,0))]",
        }),
        e.jsxs("div", {
          className:
            "relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14",
          children: [
            e.jsxs("section", {
              className:
                "relative overflow-hidden rounded-[2rem] border border-sky-200/70 bg-white/75 px-6 py-8 shadow-[0_30px_100px_-50px_rgba(2,132,199,0.5)] backdrop-blur-xl dark:border-sky-900/60 dark:bg-slate-950/70 sm:px-8 lg:px-10",
              children: [
                e.jsx("div", {
                  className:
                    "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(14,165,233,0.16),transparent_30%),radial-gradient(circle_at_bottom_left,rgba(125,211,252,0.16),transparent_28%)]",
                }),
                e.jsxs("div", {
                  className:
                  ...
                  children: [
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsxs("div", {
                          className:
                            "mb-4 inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm font-semibold text-sky-700 dark:border-sky-900/60 dark:bg-sky-950/70 dark:text-sky-300",
                          children: [
                        ...
                        e.jsx("h1", {
                          className:
                            "text-4xl font-semibold tracking-tight text-slate-900 dark:text-white sm:text-5xl lg:text-6xl",
                          children: "Terms & Conditions",
                        }),
                        e.jsx("p", {
                          className:
                            "mt-5 max-w-3xl text-base leading-8 text-slate-600 dark:text-slate-300 sm:text-lg",
                          children:
                    ...
                    e.jsxs("div", {
                      className:
                        "grid gap-3 sm:grid-cols-2 lg:w-[410px] lg:grid-cols-1",
                      children: [
                        e.jsxs("div", {
                          className:
                            "rounded-2xl border border-sky-200/70 bg-white/80 p-5 shadow-sm dark:border-sky-900/60 dark:bg-slate-900/50",
                          children: [
                            e.jsx("div", {
                              className:
                            ...
                            e.jsx("div", {
                              ...
                              children: "GarTexHub Professional Network",
                            }),
                            e.jsx("div", {
                              className:
                                "mt-1 text-sm leading-6 text-slate-600 dark:text-slate-300",
                              children: "Public route: /terms",
                            }),
                          ],
                        }),
                        e.jsxs("div", {
                          className:
                            "rounded-2xl border border-sky-200/70 bg-gradient-to-br from-sky-50 to-cyan-50 p-5 shadow-sm dark:border-sky-900/60 dark:from-sky-950/40 dark:to-cyan-950/20",
                          children: [
                            e.jsx("div", {
                              className:
                                "text-xs font-semibold uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400",
                            ...
                            e.jsx("div", {
                              className:
                                "mt-1 text-sm leading-6 text-slate-600 dark:text-slate-300",
                              children: "Dynamically generated on render.",
                            }),
                          ],
                        }),
                      ],
            ...
            e.jsx("section", {
              ...
              children: [
                ...
                e.jsxs(
                  ...
                  {
                    className:
                      "rounded-3xl border border-slate-200/80 bg-white/75 p-5 shadow-sm backdrop-blur dark:border-slate-800/80 dark:bg-slate-950/60",
                    children: [
                      e.jsx("div", {
                        className:
                          "text-xs font-semibold uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400",
                      ...
                      e.jsx("div", {
                        className:
                          "mt-2 text-base font-medium text-slate-800 dark:text-slate-100",
                        children: s,
                      }),
                    ],
                  },
            ...
            e.jsx("footer", {
              className:
                "mt-10 rounded-[2rem] border border-sky-200/70 bg-white/75 px-6 py-6 text-center shadow-sm backdrop-blur dark:border-sky-900/60 dark:bg-slate-950/60 sm:px-8",
              children: e.jsx("p", {
                className:
