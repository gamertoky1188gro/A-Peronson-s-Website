...
import { C as G } from "./chevron-left-BY_MYCfP.js";
import { S } from "./shield-BScqrUK4.js";
import { M as P } from "./map-pin-Dp9eWzEJ.js";
import { M as $ } from "./mail-DRMcVdBt.js";
import { B as A } from "./badge-check-CaFeTPUp.js";
import { E as H } from "./earth-BxQecZ9e.js";
import { U as X } from "./user-round-Bh67XmZR.js";
import { S as K } from "./search-x-BBapLPnj.js";
import { A as Q } from "./arrow-left-CJ4bAA4u.js";
function b({ children: s, tone: a = "default" }) {
  const t = {
    default:
  ...
  return e.jsx("span", {
    className: `inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-medium ${t[a] || t.default}`,
    children: s,
  });
}
function u({ label: s, value: a, helper: t }) {
  return e.jsxs("div", {
    className:
...
function v({ children: s, className: a = "" }) {
  return e.jsx("div", {
    className: `rounded-3xl border border-slate-200/70 bg-white/75 p-4 shadow-[0_10px_40px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/65 ${a}`,
    children: s,
  });
}
function W({ name: s, imageUrl: a }) {
  const t = (c) =>
    c
      ? c
          .split(/\s+/)
          ...
          .map((f) => {
            var x;
            return (x = f[0]) == null ? void 0 : x.toUpperCase();
          })
          .join("")
      : "?";
  return e.jsx("div", {
  ...
  return e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [
        e.jsx("div", {
          className:
            "mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800",
          children: e.jsx(K, { className: "h-10 w-10 text-slate-400" }),
        }),
        e.jsx("h1", {
        ...
        e.jsx("p", {
          ...
          children: "This profile doesn't exist or you may not have access.",
        }),
        e.jsxs(Y, {
          to: "/",
          className:
            "mt-6 inline-flex items-center gap-2 rounded-2xl bg-sky-600 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-sky-500/20 hover:bg-sky-500",
          children: [e.jsx(Q, { className: "h-4 w-4" }), "Back to home"],
        }),
      ],
    }),
  });
...
function oe() {
  const { id: s } = I(),
    ...
    [B, E] = h.useState(!1);
  if (
    (q({ title: "Profile — GarTexHub", url: `/profile/${s}` }),
    h.useEffect(() => {
      let r = !1;
      async function R() {
        var C;
        try {
          const g = await J("/users/lookup", {
              method: "POST",
              token: O(),
              body: { ids: [s] },
            }),
            T = (C = g == null ? void 0 : g.users) == null ? void 0 : C[0];
          r || c(T || null);
        } catch {
          r || E(!0);
        } finally {
    ...
    return e.jsx(F, { fill: !0 });
  if (B || !t) return e.jsx(Z, {});
  const o = t.role;
  if (o === "buyer") return e.jsx(j, { to: `/buyer/${s}`, replace: !0 });
  if (o === "factory") return e.jsx(j, { to: `/factory/${s}`, replace: !0 });
  if (o === "buying_house")
    return e.jsx(j, { to: `/buying-house/${s}`, replace: !0 });
  const l = t.profile || {},
    k = t.name || "User",
    p = (o || "").replace(/_/g, " "),
    U = t.avatar_url || l.avatar_url || l.profile_image || l.avatar || "",
    N = l.cover_image_url || "",
    i = l.country || "",
    n = l.company || "",
    d = l.industry || "",
    ...
    w = l.bio || "",
    m = t.email || "",
    _ = t.created_at ? new Date(t.created_at).getFullYear() : "—",
    M = [
      t.verified ? { label: "Verified", icon: V, tone: "success" } : null,
    ].filter(Boolean);
  return e.jsx("div", {
    className:
        ...
        e.jsxs("div", {
          ...
          children: [
            e.jsxs("button", {
              ...
              children: [e.jsx(G, { className: "h-4 w-4" }), " Back"],
            }),
            e.jsxs("div", {
              className:
                "flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400",
              children: [
                e.jsx(S, { className: "h-3.5 w-3.5" }),
                " Role: ",
                e.jsx("span", {
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        n
                          ...
                          : null,
                        d ? e.jsx(u, { label: "Industry", value: d }) : null,
                      ],
                    }),
                  ],
                }),
                        ...
                        e.jsxs("div", {
                          ...
                          children: [
                            n
                              ? e.jsxs("div", {
                                  className:
                                    "flex items-center gap-3 rounded-2xl bg-slate-50 p-3 dark:bg-slate-900/70",
                                  children: [
                                    e.jsx(D, {
                                      className:
              ...
              children: e.jsxs(v, {
                children: [
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx(X, { className: "h-4 w-4 text-sky-500" }),
                      e.jsx("h3", {
                        className:
                          "text-sm font-semibold tracking-wide text-slate-900 dark:text-slate-100",
                        children: "Account",
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsx("span", {
                            className:
                              "font-medium capitalize text-slate-900 dark:text-white",
                            children: p,
                          }),
                        ],
                      }),
                      t.verified !== void 0
                        ? e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsxs("span", {
                                className: `inline-flex items-center gap-1 font-medium ${t.verified ? "text-emerald-600 dark:text-emerald-400" : "text-slate-400"}`,
                                children: [
                                  t.verified
