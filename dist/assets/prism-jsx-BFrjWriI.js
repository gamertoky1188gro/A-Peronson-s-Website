    ...
    p = function (e) {
      for (var t = [], g = 0; g < e.length; g++) {
        ...
        if (
          (typeof n != "string" &&
            (n.type === "tag" && n.content[0] && n.content[0].type === "tag"
              ? n.content[0].content[0].content === "</"
                ? t.length > 0 &&
                  t[t.length - 1].tagName === s(n.content[0].content[1]) &&
                  t.pop()
              ...
              : t.length > 0 && n.type === "punctuation" && n.content === "{"
          ...
          var r = s(n);
          (g < e.length - 1 &&
            (typeof e[g + 1] == "string" || e[g + 1].type === "plain-text") &&
            ((r += s(e[g + 1])), e.splice(g + 1, 1)),
            g > 0 &&
              (typeof e[g - 1] == "string" || e[g - 1].type === "plain-text") &&
              ((r = s(e[g - 1]) + r), e.splice(g - 1, 1), g--),
            (e[g] = new a.Token("plain-text", r, null, r)));
        }
