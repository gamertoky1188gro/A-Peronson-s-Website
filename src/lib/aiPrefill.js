export function mapExtractedToForm(extracted = {}) {
  ...
  const priceMin = Number.isFinite(Number(extracted?.price?.min))
    ? Number(extracted.price.min)
    : null;
  const priceMax = Number.isFinite(Number(extracted?.price?.max))
    ? Number(extracted.price.max)
    : null;
  const priceCurrency =
    extracted?.price?.currency || extracted?.price?.currency_code || "USD";
  const priceStr =
    priceMin !== null
  ...
  const timelineDays =
    ...
    (Number.isFinite(Number(extracted?.timeline))
      ? Number(extracted.timeline)
      : null);
  const leadTime = Number.isFinite(Number(timelineDays))
    ? `${timelineDays} days`
    : extracted?.timeline || "";

  const fabricGsm = Number.isFinite(Number(extracted?.fabric?.gsm))
    ? String(extracted.fabric.gsm)
    : "";
  const moq =
    extracted?.moq !== undefined && extracted?.moq !== null
      ? String(extracted.moq)
      : "";
  ...
  return {
    ...
    moq: moq,
    target_price:
      extracted?.target_price !== undefined && extracted?.target_price !== null
        ? String(extracted.target_price)
        : priceMin !== null
          ? String(priceMin)
          : "",
    ...
    requestType:
      typeof extracted.product_type === "string" &&
      /textile/i.test(extracted.product_type)
        ? "textile"
        : "",
    ...
    totalQuantity:
      extracted.quantity !== undefined && extracted.quantity !== null
    ...
    fabricComposition:
      extracted?.fabric?.composition || extracted?.material || "",
    fiberComposition:
      extracted?.fabric?.composition || extracted?.material || "",
    ...
    complianceCerts: Array.isArray(extracted.certifications)
      ? extracted.certifications
      : Array.isArray(extracted?.compliance?.certs)
        ? extracted.compliance.certs
        : [],
    sustainabilityCerts: Array.isArray(extracted.sustainability)
      ? extracted.sustainability
      : [],
