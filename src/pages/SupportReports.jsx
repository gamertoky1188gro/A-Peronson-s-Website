                    ...
                    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                      {priorityOptions.map((item) => (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            canPrioritySupport && setPriority(item)
                          }
                    ...
                    const steps = [
                      {
                        icon: ClipboardList,
                        title: "Collected",
                        text: `Your report is grouped with the right category and priority.${tickets.length ? ` You have ${tickets.length} ticket${tickets.length > 1 ? "s" : ""} in the system.` : ""}`,
                      },
                      {
                        icon: Bug,
                        title: "Reviewed",
