...
export default function Pricing() {
  ...
  const tableRows = useMemo(() => {
    const roleSpecificFirstRow = (() => {
      if (activePlanKey === "buyer")
        return {
          label: "Structured buyer requests",
          free: true,
          premium: true,
        };
      if (activePlanKey === "factory")
        return { label: "Product management", free: true, premium: true };
      if (activePlanKey === "buying_house")
        return { label: "Partner Network", free: true, premium: true };
      return {
        label: "Buyer requests or product posts",
        free: true,
        premium: true,
      };
    })();
    ...
    return [
      ...
      { label: "AI auto-reply customization", free: false, premium: true },
      {
        ...
        free: activePlanKey === "buying_house" ? "Limited" : "Basic",
        premium: true,
      },
      {
        label: "Search filtering priority",
        free: "Standard",
        premium: "Advanced",
      },
      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-14 sm:px-6 lg:px-8">
          ...
          <MotionItem index={0} className="lg:col-span-5">
            ...
            >
              <div className="flex items-center justify-between">
                <p className="text-sm font-semibold text-[#09090b] dark:text-[#fafafa]">
                  Analytics snapshot
                </p>
              ...
              {loadError ? (
                <p className="mt-3 text-xs text-[#a1a1aa]">
                  Analytics unavailable -- showing defaults.
                </p>
              ) : null}
        ...
        <div className="mt-16" id="plans">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight text-[#09090b] dark:text-[#fafafa]">
              Simple, transparent pricing
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-[#52525b] dark:text-[#a1a1aa]">
              Choose the surface you need today -- upgrade when your team
              scales.
            </p>
          </div>
          ...
          <div className="mt-10 space-y-10">
            {visibleSections.map((section, sectionIndex) => {
              ...
              return (
                <div
                  key={section.key}
                  className="rounded-3xl shadow-borderless dark:shadow-borderlessDark bg-white/70 p-6 shadow-[0_10px_30px_rgba(2,6,23,0.06)] dark:bg-[#0f172a]/70 dark:shadow-none dark:ring-1 dark:ring-white/10"
                >
                    ...
                    <MotionItem index={sectionIndex * 2 + 1}>
                      ...
                      >
                        <div className="flex items-start justify-between gap-6">
                          <div>
                            <h3 className="text-lg font-bold tracking-tight text-[#09090b] dark:text-[#fafafa]">
                              Free
                            </h3>
          ...
          <div className="grid gap-6 md:grid-cols-6">
            ...
            <MotionItem index={4} className="md:col-span-3">
              ...
              >
                ...
                <p className="mt-2 text-sm text-[#52525b] dark:text-[#a1a1aa]">
                  Decision-ready metrics without spreadsheet UI.
                </p>
        ...
        <div className="mt-10">
          <h2 className="text-2xl font-bold tracking-tight text-[#09090b] dark:text-[#fafafa] text-center">
            Premium feature deep dive
          </h2>
          <p className="mt-2 text-center text-sm text-[#52525b] dark:text-[#a1a1aa]">
            ...
            <table className="min-w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-[#e4e4e7] dark:divide-[#27272a]">
                {tableRows.map((row) => (
                  <tr
                    key={row.label}
                    className="transition-colors hover:bg-black/2 dark:hover:bg-white/2"
                  >
                    <td className="px-6 py-4 font-medium text-[#09090b] dark:text-[#fafafa]">
                      {row.label}
                    </td>
            ...
            {[
              {
                ...
                a: "Yes -- your data stays intact.",
              },
              {
                q: "Can I downgrade*",
                a: "Yes -- plan limits apply immediately.",
              },
              {
