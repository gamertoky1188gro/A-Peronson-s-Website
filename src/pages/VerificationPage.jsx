...
export default function VerificationPage() {
  ...
  const credibilityBadge =
    verification?.credibility?.badge || "Basic credibility";
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 space-y-6">
      <header className="rounded-2xl shadow-borderless dark:shadow-borderlessDark bg-white dark:bg-white/5 p-5 ring-1 ring-slate-200/60 dark:ring-white/10">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
          Verification is subscription-based and renews monthly.
        </p>
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
          First month: $1.99 • Renewals: $6.99/month
        </p>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl shadow-borderless dark:shadow-borderlessDark bg-white dark:bg-white/5 p-5 md:col-span-2 space-y-4 ring-1 ring-slate-200/60 dark:ring-white/10">
          <div className="flex items-start justify-between gap-3">
            ...
            <div
              className={`rounded-full shadow-borderless dark:shadow-borderlessDark px-3 py-1 text-xs font-bold ${verified ? "bg-[#0A66C2]/10 text-[#0A66C2] ring-1 ring-[#0A66C2]/30" : "bg-slate-50 dark:bg-white/5 text-slate-700 dark:text-slate-200 ring-1 ring-slate-200 dark:ring-white/10"}`}
            >
            ...
            <div className="rounded-xl shadow-borderless dark:shadow-borderlessDark bg-slate-50 dark:bg-white/5 p-4 ring-1 ring-slate-200/60 dark:ring-white/10">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-slate-600 dark:text-slate-300">
                  Region: <span className="font-semibold">{buyerRegion}</span>
                </span>
              </div>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {requiredDocs.map((documentKey) => {
              ...
              return (
                <div
                  key={documentKey}
                  className="rounded-2xl shadow-borderless dark:shadow-borderlessDark bg-white dark:bg-slate-950 p-4 flex items-center justify-between gap-3 ring-1 ring-slate-200/60 dark:ring-white/10"
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`rounded-full shadow-borderless dark:shadow-borderlessDark px-3 py-1 text-xs font-bold${statusChipClass(status)}`}
                    >
                      {status}
                    </span>
                    <button
          ...
          {feedback ? (
            <div className="text-sm text-emerald-700">{feedback}</div>
          ) : null}
        ...
        <aside className="rounded-2xl shadow-borderless dark:shadow-borderlessDark bg-white dark:bg-white/5 p-5 space-y-3 ring-1 ring-slate-200/60 dark:ring-white/10">
          ...
          <div className="rounded-2xl shadow-borderless dark:shadow-borderlessDark bg-slate-50 dark:bg-white/5 p-4 ring-1 ring-slate-200/60 dark:ring-white/10">
            ...
            <p className="mt-2 text-xs text-slate-600 dark:text-slate-300">
              More licensing proof increases credibility and international
              trust.
            </p>
          </div>
          ...
          <div className="rounded-2xl shadow-borderless dark:shadow-borderlessDark bg-slate-50 dark:bg-white/5 p-4 ring-1 ring-slate-200/60 dark:ring-white/10">
            ...
            {remainingDays ? (
              <p
                className={`mt-2 text-[11px] ${expiringSoon ? "text-amber-700 dark:text-amber-300" : "text-slate-600 dark:text-slate-300"}`}
              >
