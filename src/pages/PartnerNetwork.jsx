      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-4 flex items-center gap-3">
          <input
            ...
            className="px-3 py-2 shadow-borderless ring-1 ring-slate-200/60 rounded w-72 bg-white focus:outline-none focus:ring-2 focus:ring-gtBlue/25 dark:bg-white/5 dark:shadow-borderlessDark dark:ring-white/10"
          />
          <div className="text-sm text-slate-600 dark:text-slate-300">
            Signed in as: {user?.role || "unknown"}
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredRows.map((row) => {
            ...
            return (
              <div
                key={row.id}
                className="rounded-2xl bg-white shadow-borderless ring-1 ring-slate-200/60 p-4 dark:bg-white/5 dark:shadow-borderlessDark dark:ring-white/10"
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  {counterparty.verified && (
                    <div className="text-sm text-gtBlue font-semibold">
                      ✓ Verified
                    </div>
                  )}
                </div>
                  ...
                  {row.status === "pending" && canManage && isIncoming && (
                    <>
                      <button
                        ...
                        className="px-3 py-1 shadow-borderless dark:shadow-borderlessDark rounded text-sm"
                        disabled={loading}
                      >
                        Accept
                      </button>
