    ...
    <div className="min-h-screen bg-slate-50 p-6 text-slate-900 transition-colors duration-500 dark:bg-[#020617] dark:text-slate-100">
      ...
      <div className="max-w-3xl mx-auto mt-16 rounded-2xl bg-white p-8 shadow-borderless ring-1 ring-slate-200/60 dark:bg-white/5 dark:shadow-borderlessDark dark:ring-white/10">
        <div className="flex items-center justify-between">
          ...
          <button type="button" onClick={handleBack} className="text-sm text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">
            Back
          </button>
        </div>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link to="/login" className="px-4 py-2 rounded-lg bg-gtBlue hover:bg-gtBlueHover text-white">Login with another account</Link>
          <Link to="/feed" className="px-4 py-2 rounded-lg bg-white shadow-borderless ring-1 ring-slate-200/60 hover:bg-slate-50 dark:bg-white/5 dark:shadow-borderlessDark dark:ring-white/10 dark:hover:bg-white/8">Go to Feed</Link>
        </div>
      </div>
    </div>
  )
