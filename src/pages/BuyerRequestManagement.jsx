/**
 * @typedef {Object} BuyerRequestForm
 * @property {string} requestType
 * @property {string} title
 * @property {string} industry
 * @property {string} category
 * @property {string} genderTarget
 * @property {string} season
 * @property {string} totalQuantity
 * @property {string} numberOfStyles
 * @property {string} fabricComposition
 * @property {string} fabricWeightGsm
 * @property {string} weaveOrKnit
 * @property {string} sizeRange
 * @property {string} colorRequirement
 * @property {string} styleDescription
 * @property {string} techPackRequired
 * @property {string} targetFobPrice
 * @property {string} incoterms
 * @property {string} destinationPort
 * @property {string} exFactoryDate
 * @property {string} sampleRequired
 * @property {string} sampleType
 * @property {string} paymentTerms
 * @property {string[]} complianceCerts
 * @property {string[]} sustainabilityCerts
 * @property {string} complianceNotes
 * @property {string} materialType
 * @property {string} subCategory
 * @property {string} quantity
 * @property {string} unit
 * @property {string} fiberComposition
 * @property {string} fabricWidth
 * @property {string} yarnCount
 * @property {string} threadCount
 * @property {string} finishRequired
 * @property {string} stretchRequired
 * @property {string} color
 * @property {string} pattern
 * @property {string} targetPrice
 * @property {string} priceUnit
 * @property {string} deliveryPort
 * @property {string} leadTimeRequired
 * @property {string} labTestRequired
 * @property {string} swatchFirst
 * @property {string} labCertNotes
 * @property {string} quoteDeadline
 * @property {string} expiresAt
 * @property {string} maxSuppliers
 * @property {boolean} verifiedOnly
 * @property {string} preferredFactoryLocation
 * @property {string} factorySizePreference
 * @property {string} exportExperiencePreference
 * @property {boolean} confidentialityToggle
 * @property {string} packagingRequirement
 * @property {string} originLabelRequired
 * @property {string} hangtagBarcode
 * @property {string} partialShipmentAllowed
 * @property {string} shipmentMode
 * @property {Array<{label: string, value: string}>} customFields
...
/*
  ...
  Allowed roles: buyer, buying_house, admin

  Primary responsibilities:
    - Manage buyer requests (create, edit, delete, assign).
...
/**
 * Converts API requirement to form data.
            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className={`mt-1 max-w-3xl text-sm sm:text-base ${soft}`}>
                    {roleSubtitle}
                  </p>
                </div>
              </div>
                    ...
                    <div className="mb-5 space-y-2">
                      ...
                      {attachmentFeedback ? (
                        <div className="rounded-2xl border border-sky-500/20 bg-sky-500/10 px-4 py-3 text-sm text-sky-700 dark:text-sky-200">
                          <CloudUpload className="mr-2 inline-block h-4 w-4" />{" "}
                          {attachmentFeedback}
                        </div>
                      ) : null}
                      {aiParseFeedback ? (
                  ...
                  {role === "buyer" ? (
                      ...
                      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                        <div>
                          ...
                          <div className={`mt-1 text-sm ${soft}`}>
                            Complete each step so verified suppliers can quote
                            faster.
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            disabled={
                              aiParsing || !form.customDescription.trim()
                            }
                      ...
                      <div className="space-y-5">
                        {step === 0 ? (
                          <div className="grid gap-4 md:grid-cols-2">
                            ...
                            >
                              ...
                              <div className={`mt-1 text-sm ${soft}`}>
                                Finished garments with design + construction
                                focus.
                              </div>
                            </button>
                            <button
                              ...
                              onClick={() =>
                                setForm({ ...form, requestType: "textile" })
                              }
                            >
                              <div className="mb-3 flex items-center justify-between">
                                <div className="rounded-2xl bg-gradient-to-br from-sky-500 to-cyan-400 p-3 text-white shadow-lg shadow-sky-500/20">
                        ...
                        {step === 1 ? (
                          <div className="grid gap-4 md:grid-cols-2">
                            <Field
                              ...
                              error={
                                fieldErrors.title || fieldErrors.request_title
                              }
                            >
                              <Input
                                value={form.title}
                            ...
                            {isTextile ? (
                              ...
                              <>
                                ...
                                <Field
                                  ...
                                  required
                                  error={
                                    fieldErrors.genderTarget ||
                                    fieldErrors.gender_target
                                  }
                                >
                                  <Select
                            ...
                            >
                              <Input
                                ...
                                onChange={(e) =>
                                  setForm({
                                    ...form,
                                    fabricWeightGsm: e.target.value,
                                  })
                                }
                                placeholder="180"
                              />
                            ...
                            <Field label="Stretch required">
                              <Input
                                ...
                                onChange={(e) =>
                                  setForm({
                                    ...form,
                                    stretchRequired: e.target.value,
                                  })
                                }
                          ...
                          <div className="grid gap-4 md:grid-cols-2">
                            <Field label="Fabric composition">
                              <Input
                                ...
                                placeholder="98% cotton, 2% elastane"
                              />
                            </Field>
                            ...
                            <Field label="Color requirement">
                              <Input
                                ...
                                onChange={(e) =>
                                  setForm({
                                    ...form,
                                    colorRequirement: e.target.value,
                                  })
                                }
                                placeholder="Indigo and black"
                              />
                            </Field>
                            <Field label="Style description">
                              <TextArea
                                ...
                                placeholder="Premium structured jacket..."
                              />
                              <WordCount
                                text={form.styleDescription}
                                limit={(() => {
                            ...
                            <Field label="Tech pack required">
                              <Input
                                ...
                                onChange={(e) =>
                                  setForm({
                                    ...form,
                                    techPackRequired: e.target.value,
                                  })
                                }
                                placeholder="Yes / No"
                              />
                              ...
                              >
                                {pendingAttachments.length ? (
                                  ...
                                  <p className="text-xs text-slate-500">
                                    You can upload tech packs and sketches after
                                    posting too.
                                  </p>
                                )}
                          ...
                          <div className="grid gap-4 md:grid-cols-2">
                            {isTextile ? (
                              <>
                                ...
                                <Field
                                  ...
                                  required
                                  error={
                                    fieldErrors.priceUnit ||
                                    fieldErrors.price_unit
                                  }
                                >
                                  <Input
                                ...
                                <Field
                                  ...
                                  required
                                  error={
                                    fieldErrors.deliveryPort ||
                                    fieldErrors.delivery_port
                                  }
                                >
                                  <Input
                                ...
                                >
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      setForm({
                                        ...form,
                                        leadTimeRequired: e.target.value,
                                      })
                                    }
                                    placeholder="30 days"
                                  />
                                ...
                                <Field label="Lab test required">
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      setForm({
                                        ...form,
                                        labTestRequired: e.target.value,
                                      })
                                    }
                                    placeholder="Yes / No"
                                  />
                              ...
                              <>
                                ...
                                <Field
                                  ...
                                  required
                                  error={
                                    fieldErrors.exFactoryDate ||
                                    fieldErrors.ex_factory_date
                                  }
                                >
                                  <Input
                                    type="date"
                            ...
                            {moreFieldsOpen ? (
                              <>
                                ...
                                <Field
                                  label="Max suppliers to contact"
                                  hint="Optional"
                                >
                                  <Input
                                  ...
                                  <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                                    ...
                                    >
                                      ...
                                      <div className={`mt-1 text-xs ${soft}`}>
                                        verified goes to inbox, unverified goes
                                        to requests
                                      </div>
                                    </button>
                                    <button
                        ...
                        {step === 4 ? (
                          <div className="grid gap-4 xl:grid-cols-2">
                            <div
                              className={`rounded-[26px] border p-5 ${panel}`}
                            >
                                ...
                                <>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                      {GARMENT_COMPLIANCE_CERTS.map((cert) => (
                                        ...
                                        >
                                          <input
                                            type="checkbox"
                                            checked={form.complianceCerts.includes(
                                              cert,
                                            )}
                                            onChange={(e) => {
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                      {GARMENT_SUSTAIN_CERTS.map((cert) => (
                                        ...
                                        >
                                          <input
                                            type="checkbox"
                                            checked={form.sustainabilityCerts.includes(
                                              cert,
                                            )}
                                            onChange={(e) => {
                                              const next = e.target.checked
                                  ...
                                  <Field label="Compliance notes">
                                    <TextArea
                                      ...
                                      placeholder="Traceability, audit readiness..."
                                    />
                                  </Field>
                                </>
                              ) : (
                                ...
                                <Field label="Confidentiality">
                                  ...
                                  >
                                    <input
                                      ...
                                      className="h-4 w-4 accent-sky-500"
                                    />
                                    Hide brand name (only verified suppliers can
                                    see it)
                                  </label>
                                </Field>
                              </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Pill className="bg-cyan-500/15 text-cyan-300">
                          Assign to agents
                        </Pill>
                        <Pill
                              ...
                              <tbody className="divide-y divide-white/10">
                                {myRequests.map((r) => (
                                  <tr key={r.id} className="hover:bg-white/5">
                                    ...
                                    <td className="px-4 py-4">
                                      <span
                                        className={`${badge} ${requestStatusBadge(r.status)}`}
                                      >
                                    ...
                                    <td className="px-4 py-4">
                                      <Select
                                        ...
                                        onChange={(e) =>
                                          assignRequest(r.id, e.target.value)
                                        }
                                      >
                    ...
                    <div className={`rounded-[28px] border p-5 ${panel}`}>
                      <div className="mb-4 flex items-center justify-between gap-3">
                        <div>
                          ...
                          <p className={`text-sm ${soft}`}>
                            Duplicate, smart match, edit, delete, and manage
                            attachments.
                          </p>
                        </div>
                        <button
                                ...
                                >
                                  {editingId === r.id ? (
                                    <div className="space-y-3">
                                      ...
                                      <Field label="Custom description">
                                        ...
                                        />
                                        <WordCount
                                          text={editForm.customDescription}
                                          limit={(() => {
                                            const u = getCurrentUser();
                                            return String(
                                              u?.subscription_status || "",
                                    ...
                                    <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                                      ...
                                      >
                                        ...
                                        >
                                          Tech pack, sketch, reference image,
                                          compliance, other
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  {!canSmartMatch ? (
                                    <div className="mt-4 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-3 text-xs text-amber-700 dark:text-amber-200">
                                      Smart supplier matching is a Premium
                                      feature.
                                      <div className="mt-2">
                                        <Link
                                          to="/pricing"
                    ...
                    <div className={`rounded-[28px] border p-5 ${panel}`}>
                      <div className="mb-4 flex items-center justify-between">
                        <div>
                          ...
                          <p className={`text-sm ${soft}`}>
                            You can research market demand, but full details
                            remain private.
                          </p>
                        </div>
                        <button
