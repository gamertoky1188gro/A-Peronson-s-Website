          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 dark:bg-slate-900/50 dark:ring-slate-800">
            ...
            {step === 0 ? (
              <div className="space-y-4">
                ...
                <p className="text-sm text-slate-600">
                  Select the buyer request type so we can show the correct
                  fields.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    onClick={() =>
                      setForm({ ...form, requestType: "garments" })
                    }
                  >
            ...
            {step === 1 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <input
                    className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                    value={form.title}
                    onChange={(e) =>
                ...
                {isTextile ? (
                  <>
                    <Field
                      label="Material type"
                      error={
                        fieldErrors.materialType || fieldErrors.material_type
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                    ...
                    <Field
                      label="Sub-category"
                      error={
                        fieldErrors.subCategory || fieldErrors.sub_category
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                  ...
                  <>
                    ...
                    <Field
                      label="Gender target"
                      error={
                        fieldErrors.genderTarget || fieldErrors.gender_target
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        ...
                        onChange={(e) =>
                          setForm({ ...form, genderTarget: e.target.value })
                        }
                      />
                    </Field>
                    ...
                    {!isTextile ? (
                      <Field label="Number of styles (optional)">
                        <input
                          ...
                          onChange={(e) =>
                            setForm({ ...form, numberOfStyles: e.target.value })
                          }
                        />
                      </Field>
                    ) : null}
                ...
                {isTextile ? (
                  <>
                    <Field
                      ...
                      error={
                        fieldErrors.fiberComposition ||
                        fieldErrors.fiber_composition
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        ...
                        onChange={(e) =>
                          setForm({ ...form, fiberComposition: e.target.value })
                        }
                      />
                    </Field>
                    <Field
                      ...
                      error={
                        fieldErrors.fabricWeightGsm ||
                        fieldErrors.fabric_weight_gsm ||
                        fieldErrors.fabric_weight
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        ...
                        onChange={(e) =>
                          setForm({ ...form, fabricWeightGsm: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Fabric width">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, fabricWidth: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Yarn count">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, yarnCount: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Thread count">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, threadCount: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Finish required">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.finishRequired}
                        onChange={(e) =>
                          setForm({ ...form, finishRequired: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Stretch required">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.stretchRequired}
                        onChange={(e) =>
                          setForm({ ...form, stretchRequired: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Color">
                  ...
                  <>
                    ...
                    <Field label="Weave / Knit type">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.weaveOrKnit}
                        onChange={(e) =>
                          setForm({ ...form, weaveOrKnit: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Size range">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, sizeRange: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Color requirement">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.colorRequirement}
                        onChange={(e) =>
                          setForm({ ...form, colorRequirement: e.target.value })
                        }
                      />
                    </Field>
                    ...
                    <Field label="Tech pack required">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.techPackRequired}
                        onChange={(e) =>
                          setForm({ ...form, techPackRequired: e.target.value })
                        }
                        placeholder="Yes / No"
                      />
                    </Field>
                      ...
                      {pendingAttachments.length ? (
                        pendingAttachments.map((fileRow, index) => (
                          <div
                            ...
                            className="flex items-center justify-between rounded-lg bg-white px-2 py-2 ring-1 ring-slate-200/60"
                          >
                        ...
                        <p className="text-[11px] text-slate-500">
                          You can upload tech packs and sketches after posting
                          too.
                        </p>
                      )}
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {isTextile ? (
                  <>
                    ...
                    <Field
                      label="Price unit"
                      error={fieldErrors.priceUnit || fieldErrors.price_unit}
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                    ...
                    <Field
                      label="Incoterm"
                      error={fieldErrors.incoterms || fieldErrors.incoterm}
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                    ...
                    <Field
                      label="Delivery port"
                      error={
                        fieldErrors.deliveryPort || fieldErrors.delivery_port
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        ...
                        onChange={(e) =>
                          setForm({ ...form, deliveryPort: e.target.value })
                        }
                      />
                    </Field>
                    <Field
                      ...
                      error={
                        fieldErrors.leadTimeRequired ||
                        fieldErrors.lead_time_required
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.leadTimeRequired}
                        onChange={(e) =>
                          setForm({ ...form, leadTimeRequired: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Lab test required">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.labTestRequired}
                        onChange={(e) =>
                          setForm({ ...form, labTestRequired: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Swatch/sample first?">
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.swatchFirst}
                        onChange={(e) =>
                          setForm({ ...form, swatchFirst: e.target.value })
                        }
                      />
                    </Field>
                  </>
                  ...
                  <>
                    <Field
                      label="Target FOB price"
                      error={
                        fieldErrors.targetFobPrice ||
                        fieldErrors.price_range ||
                        fieldErrors.target_fob_price
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.targetFobPrice}
                        onChange={(e) =>
                          setForm({ ...form, targetFobPrice: e.target.value })
                        }
                      />
                    </Field>
                    <Field
                    ...
                    <Field
                      ...
                      error={
                        fieldErrors.exFactoryDate || fieldErrors.ex_factory_date
                      }
                    >
                      <input
                        type="date"
                        ...
                        onChange={(e) =>
                          setForm({ ...form, exFactoryDate: e.target.value })
                        }
                      />
                    </Field>
                    <Field label="Sample required">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, sampleRequired: e.target.value })
                        }
                        placeholder="Yes / No"
                      />
                    </Field>
                    ...
                    <Field
                      label="Payment terms"
                      error={
                        fieldErrors.paymentTerms || fieldErrors.payment_terms
                      }
                    >
                      <input
                        className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                  ...
                  <>
                    <Field label="Quote deadline">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, quoteDeadline: e.target.value })
                        }
                      />
                    </Field>
                    ...
                    <Field label="Max suppliers to contact">
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, maxSuppliers: e.target.value })
                        }
                      />
                    </Field>
                    <Field
                      ...
                      <div className="grid grid-cols-1 gap-2 text-sm text-slate-700">
                        <label className="flex items-center gap-2">
                          <input
                            ...
                            onChange={() =>
                              setForm({ ...form, verifiedOnly: false })
                            }
                          />
                          Normal
                        </label>
                        <label className="flex items-center gap-2">
                          <input
                            ...
                            checked={form.verifiedOnly}
                            onChange={() =>
                              setForm({ ...form, verifiedOnly: true })
                            }
                          />
              ...
              <div className="space-y-4">
                ...
                {!isTextile ? (
                  <>
                    <Field label="Compliance certifications">
                      <div className="flex flex-wrap gap-2">
                        {GARMENT_COMPLIANCE_CERTS.map((cert) => (
                          <label
                            key={cert}
                            className="inline-flex items-center gap-2 rounded-full shadow-borderless dark:shadow-borderlessDark px-3 py-1 text-xs"
                          >
                            <input
                              type="checkbox"
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const next = e.target.checked
                                  ...
                                  : form.sustainabilityCerts.filter(
                                      (c) => c !== cert,
                                    );
                    ...
                    <Field label="Compliance notes">
                      <textarea
                        className="w-full min-h-25 rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        value={form.complianceNotes}
                        onChange={(e) =>
                          setForm({ ...form, complianceNotes: e.target.value })
                        }
                      />
                    </Field>
                  </>
                  ...
                  <Field label="Lab/Certification notes">
                    <textarea
                      className="w-full min-h-25 rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                      value={form.labCertNotes}
                      onChange={(e) =>
                        setForm({ ...form, labCertNotes: e.target.value })
                      }
                    />
                  </Field>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Field label="Preferred factory location">
                    <input
                      ...
                      onChange={(e) =>
                        setForm({
                          ...form,
                          preferredFactoryLocation: e.target.value,
                        })
                      }
                      placeholder="Gazipur / Chittagong / Any"
                    />
                  </Field>
                  <Field label="Factory size preference">
                    <input
                      className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                      value={form.factorySizePreference}
                      onChange={(e) =>
                        setForm({
                          ...form,
                          factorySizePreference: e.target.value,
                        })
                      }
                  ...
                  <Field label="Export experience preference">
                    <input
                      className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                      value={form.exportExperiencePreference}
                      onChange={(e) =>
                        setForm({
                          ...form,
                          exportExperiencePreference: e.target.value,
                        })
                      }
                      placeholder="EU required / US required / Any"
                    />
                  </Field>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Field label="Packaging requirement">
                    <input
                      ...
                      onChange={(e) =>
                        setForm({
                          ...form,
                          packagingRequirement: e.target.value,
                        })
                      }
                      placeholder="Poly bag / Hanger / Flat pack"
                    />
                  </Field>
                  <Field label="Origin label requirement">
                    <input
                      className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                      value={form.originLabelRequired}
                      onChange={(e) =>
                        setForm({
                          ...form,
                          originLabelRequired: e.target.value,
                        })
                      }
                      placeholder="Made in Bangladesh required?"
                    />
                  </Field>
                  <Field label="Hang tag / Barcode">
                    <input
                      className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                      value={form.hangtagBarcode}
                      onChange={(e) =>
                        setForm({ ...form, hangtagBarcode: e.target.value })
                      }
                      placeholder="Buyer-supplied / Factory to arrange"
                    />
                  </Field>
                  <Field label="Partial shipment allowed">
                    <input
                      className="w-full rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                      value={form.partialShipmentAllowed}
                      onChange={(e) =>
                        setForm({
                          ...form,
                          partialShipmentAllowed: e.target.value,
                        })
                      }
                      placeholder="Yes / No"
                    />
                  ...
                  <Field label="Shipment mode">
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, shipmentMode: e.target.value })
                      }
                      placeholder="Sea / Air / Both"
                    />
                  </Field>
                </div>
                ...
                {moreFieldsOpen ? (
                  <div className="rounded-xl shadow-borderless dark:shadow-borderlessDark p-3">
                    ...
                    <div className="mt-2 space-y-2">
                      {(Array.isArray(form.customFields)
                        ...
                        >
                          ...
                          <button
                            type="button"
                            className="rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2 text-xs font-semibold"
                    ...
                    <button
                      type="button"
                      className="mt-2 text-[11px] font-semibold text-(--gt-blue)"
                ...
                >
                  <textarea
                    className="w-full min-h-35 rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                    value={form.customDescription}
                    onChange={(e) =>
                      setForm({ ...form, customDescription: e.target.value })
                    }
                  />
                ...
                <div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200/70">
                  ...
                  <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-slate-600">
                    {previewRows.map((row) => (
                      <div
                        key={row.label}
                        className="rounded-lg bg-white px-3 py-2 ring-1 ring-slate-200/60"
                      >
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 dark:bg-slate-900/50 dark:ring-slate-800">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  <span className="font-semibold">Assign</span> routes a request
                  to an Agent ID so teammates don’t overlap work.
                </p>
              </div>
              <button
                type="button"
                onClick={loadRequests}
                className="rounded-full shadow-borderless dark:shadow-borderlessDark px-3 py-2 text-xs font-semibold hover:bg-slate-50"
              >
                Refresh
              </button>
            </div>
            ...
            {!loading && myRequests.length === 0 ? (
              <div className="text-sm text-slate-600">No open requests.</div>
            ) : null}
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody>
                  {myRequests.map((r) => (
                    <tr
                      key={r.id}
                      className="shadow-dividerT dark:shadow-dividerTDark"
                    >
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 dark:bg-slate-900/50 dark:ring-slate-800">
            ...
            <div className="space-y-3">
              {myRequests.map((r) => {
                ...
                const selectedType =
                  attachmentTypeByRequest[r.id] || "tech_pack";
                return (
                  <div
                    key={r.id}
                    className="rounded-2xl bg-white p-4 ring-1 ring-slate-200/60 dark:bg-slate-950/30 dark:ring-white/10"
                  >
                    {editingId === r.id ? (
                      <div className="space-y-3">
                        <Field label="Title">
                        ...
                        <Field label="Custom description">
                          <textarea
                            className="w-full min-h-30 rounded-lg shadow-borderless dark:shadow-borderlessDark px-3 py-2"
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            type="button"
                            className="rounded-lg shadow-borderless dark:shadow-borderlessDark px-4 py-2 text-sm font-semibold"
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            ...
                            <div className="mt-1 text-xs text-slate-500">
                              Qty {r.quantity || "--"} - {r.material || "--"} -
                              Target {r.target_market || "--"} - Delivery{" "}
                              {r.delivery_timeline || r.timeline_days || "--"}
                            </div>
                          </div>
                          <div className="shrink-0 flex gap-2">
                            ...
                            <button
                              type="button"
                              className="rounded-full shadow-borderless dark:shadow-borderlessDark px-3 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-50"
                        ...
                        {!canSmartMatch ? (
                          <div className="rounded-xl bg-amber-50 p-3 text-xs text-amber-800 ring-1 ring-amber-200/70">
                            ...
                            <div className="mt-2">
                              <Link
                                to="/pricing"
                                className="text-[11px] font-semibold text-(--gt-blue) hover:underline"
                              >
                                Upgrade to unlock
                              </Link>
                            </div>
                              ...
                              {(smartMatches[r.id] || [])
                                ...
                                .map((match) => (
                                  <div
                                    ...
                                    className="flex items-center justify-between rounded-lg bg-white px-2 py-2 text-xs ring-1 ring-slate-200/60"
                                  >
                        ...
                        <div className="rounded-xl bg-slate-50 p-3 ring-1 ring-slate-200/70">
                          ...
                          <div className="mt-2 space-y-2">
                            {attachments.length ? (
                              attachments.map((doc) => (
                                <div
                                  key={doc.id}
                                  className="flex items-center justify-between gap-2 rounded-lg bg-white px-2 py-2 ring-1 ring-slate-200/60"
                                >
                                  <a
                          ...
                          <div className="mt-3 flex flex-wrap items-center gap-2">
                            <select
                              ...
                              value={selectedType}
                              onChange={(e) =>
                                setAttachmentTypeByRequest((prev) => ({
                                  ...prev,
                                  [r.id]: e.target.value,
                                }))
                              }
                            ...
                            <label className="text-xs font-semibold text-(--gt-blue) cursor-pointer">
                              ...
                              <input
                                ...
                                onChange={(event) => {
                                  const file = event.target.files?.[0];
                                  if (file)
                                    uploadAttachment(r.id, file, selectedType);
                                  event.target.value = "";
                                }}
                              />
                            </label>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/60 dark:bg-slate-900/50 dark:ring-slate-800">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  You can research market demand, but full details remain
                  private.
                </p>
              </div>
              <button
                  ...
                  >
                    ...
                    <div className="mt-3 flex gap-2">
                      <Link
                        ...
                        className="rounded-full bg-white px-3 py-2 text-xs font-semibold text-slate-800 ring-1 ring-slate-200/70 hover:bg-slate-50"
                      >
                        View Buyer Profile
                      </Link>
                    </div>
