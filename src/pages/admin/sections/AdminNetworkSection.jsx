        ...
        >
          <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              ...
              >
                Topology status, alerts, and real-time diagnostics with premium
                visibility across devices, security, traffic, and audit history.
              </p>
            </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                [
                  ...
                  vlanForm.vlan_id,
                  (value) =>
                    setVlanForm((prev) => ({ ...prev, vlan_id: value })),
                ],
                [
                  "Name",
                  vlanForm.name,
                  (value) =>
                    setVlanForm((prev) => ({ ...prev, name: value })),
                ],
                [
                  "Subnet",
                  vlanForm.subnet,
                  (value) =>
                    setVlanForm((prev) => ({ ...prev, subnet: value })),
                ],
                [
                  "Gateway",
                  vlanForm.gateway,
                  (value) =>
                    setVlanForm((prev) => ({ ...prev, gateway: value })),
                ],
          ...
          >
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                [
                  ...
                  ipamForm.ip,
                  (value) =>
                    setIpamForm((prev) => ({ ...prev, ip: value })),
                ],
                [
                  "Owner",
                  ipamForm.owner,
                  (value) =>
                    setIpamForm((prev) => ({ ...prev, owner: value })),
                ],
                [
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <button
                type="button"
                onClick={() =>
                  runNetworkAction("config.backup", backupForm)
                }
                ...
                .map((row) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        runNetworkAction("ipam.release", { ip: row.ip })
                      }
                      className={cn(
                        "rounded-xl border px-3 py-1.5 text-xs font-semibold",
                        adminDark
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              >
                ...
                >
                  Firmware jobs:{" "}
                  {(networkInventory?.firmware_jobs || []).length} · Bulk
                  config jobs:{" "}
                  {(networkInventory?.bulk_config_jobs || []).length}
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  Config audits:{" "}
                  {(networkInventory?.config_audit || []).length} · QoS
                  policies: {(networkInventory?.qos_policies || []).length}
                </div>
                <div
                  className={cn(
                    "rounded-2xl border px-4 py-3 text-sm",
                ...
                >
                  Traffic shaping:{" "}
                  {(networkInventory?.traffic_shapes || []).length} ·
                  Restore jobs:{" "}
            ...
            >
              ...
              >
                ...
                >
                  Active tunnels:{" "}
                  {(networkInventory?.tunnels || []).length} · VPN
                  tunnels:{" "}
                ...
                >
                  Firewall policies:{" "}
                  {(networkInventory?.firewall_policies || []).length}
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-2">
                  {verificationQueue.slice(0, 4).map((row) => (
                    ...
                    >
                      ...
                      >
                        Doc:{" "}
                        {row.doc_type || row.type || "business"} ·
        ...
        >
          ...
          >
            ...
            <div
              className={cn(
                "divide-y",
                adminDark ? "divide-white/10" : "divide-slate-200",
              )}
            >
                ...
                >
                  ...
                  >
                    <div className="truncate">
                      Actor:{" "}
                      {entry.actor_id || entry.actor || "system"}
                    </div>
                    <div
                      className={
                        adminDark
