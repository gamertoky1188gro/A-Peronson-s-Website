    ...
    <div className="space-y-6">
      ...
      {networkNav === "overview" && (
        <div className="grid gap-6 md:grid-cols-3">
          <div className={cn(
            ...
            <div className="text-3xl font-bold">{networkData?.interfaces || 0}</div>
          ...
          <div className={cn(
            ...
            <div className="text-3xl font-bold">{networkData?.connections || 0}</div>
      ...
      {networkNav === "analytics" && (
        <div className={cn(
          ...
          <p className="text-slate-500">Traffic analysis and performance metrics</p>
        </div>
      )}
