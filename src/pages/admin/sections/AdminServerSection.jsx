    ...
    <div className="space-y-6">
      ...
      {serverNav === "overview" && (
        <div className="grid gap-6 md:grid-cols-4">
          <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white")}>
            <div className="text-3xl font-bold">{serverData?.totalServers || 0}</div>
          ...
          <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white")}>
            <div className="text-3xl font-bold">{serverData?.databases || 0}</div>
            <div className="text-sm text-slate-500">Databases</div>
          </div>
          <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10 bg-white/5" : "border-slate-200 bg-white")}>
            <div className="text-3xl font-bold">{serverData?.storage || "0 GB"}</div>
      ...
      {serverNav === "servers" && (
        <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10" : "border-slate-200")}>
          <h3 className={cn("mb-4 text-lg font-semibold", adminDark ? "text-white" : "text-slate-900")}>Server List</h3>
      ...
      {serverNav === "databases" && (
        <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10" : "border-slate-200")}>
          <h3 className={cn("mb-4 text-lg font-semibold", adminDark ? "text-white" : "text-slate-900")}>Database Management</h3>
      ...
      {serverNav === "storage" && (
        <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10" : "border-slate-200")}>
          <h3 className={cn("mb-4 text-lg font-semibold", adminDark ? "text-white" : "text-slate-900")}>Storage Management</h3>
      ...
      {serverNav === "maintenance" && (
        <div className={cn("rounded-2xl border p-6", adminDark ? "border-white/10" : "border-slate-200")}>
          <h3 className={cn("mb-4 text-lg font-semibold", adminDark ? "text-white" : "text-slate-900")}>Maintenance</h3>
