...
export function AdminInfraSection({
  ...
  const emptyCopy = (key, fallback) => fallback;
            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div>
                  ...
                  >
                    Professional operations console with auditability, safety
                    guards, and premium status surfaces.
                  </p>
                </div>
              </div>
                  ...
                  <div className="space-y-3">
                    {verificationQueue.slice(0, 3).map((row) => (
                      ...
                      >
                        ...
                        >
                          Doc:{" "}
                          {row.doc_type || row.type || "business"} · Status:{" "}
                          {row.status || "pending"}
                        </div>
                      </div>
                    ))}
                        ...
                        .map((rule) => (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                runInfraAction("firewall.remove_rule", {
                                  rule_id: rule.id,
                                })
                              }
                              className={cn(
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className={infraFieldPanel}>
                        ...
                        >
                          Run controlled update scans without auto-installing
                          risky packages.
                        </p>
                      </div>
                      <div className={infraFieldPanel}>
                        ...
                        >
                          Only verified operators may apply changes on
                          production nodes.
                        </p>
                      </div>
                    </div>
                ...
                >
                  <div className="space-y-3">
                    <button
                      type="button"
                      onClick={() =>
                        runInfraAction("process.scan_zombies")
                      }
                      className={cn(
              ...
              >
                <div className="space-y-3">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      runInfraAction("ssh.key.add", sshKeyForm)
                    }
                    className={cn(
              ...
              <SectionCard
                ...
                onAction={async () => {
                  ...
                  if (infraBackupForm.retention_days)
                    await runInfraAction("backup.retention", {
                      retention_days: infraBackupForm.retention_days,
                    });
                  if (timeForm.timezone)
                    await runInfraAction("system.timezone.set", {
              ...
              >
                <div className="space-y-3">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      runInfraAction("system.timezone.set", {
                        timezone: timeForm.timezone,
                      })
                    }
                    className={cn(
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      <span>
                        Retention:{" "}
                        {infraState?.backups?.retention_days || 0} days ·
                        SSLs: {(infraState?.ssl_certs || []).length}
                      </span>
                      <span
                        className={
                          adminDark
                      ...
                      >
                        Timezone:{" "}
                        {infraState?.time_settings?.timezone || "unset"}
                      </span>
                    </div>
                    <div className="mt-2 text-xs">
                      NTP sync:{" "}
                      {infraState?.time_settings?.last_sync_at || "never"}
                    </div>
                  </div>
                </div>
              </SectionCard>
                ...
                <div className="space-y-3">
                  {filteredInfraAuditRows.slice(0, 8).map((entry) => (
                    ...
                    >
                      ...
                      >
                        <div>
                          Actor: {entry.actor_id || entry.actor || "system"}
                        </div>
                        <div>
                          IP: {entry.ip || "--"} / Device:{" "}
                          {entry.device_id || "--"}
          ...
          >
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2">
                <Server className="h-4 w-4 text-sky-500" /> Premium
                infrastructure control surface
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="h-4 w-4 text-cyan-400" /> Blue-sky
                themed • audit-first • responsive
              </div>
            </div>
          </footer>
        </div>
