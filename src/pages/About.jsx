        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          <MotionItem index={1} className="lg:col-span-4">
            ...
            >
              ...
              {loadError ? (
                <p className="mt-3 text-xs text-[#64748B] dark:text-slate-300">
          ...
          <MotionItem index={2} className="lg:col-span-12">
            ...
            >
              <h2 className="text-xl font-bold tracking-tight text-[#1E293B] dark:text-white">
                Why GarTexHub Exists
              </h2>
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                Cross-border textile trade often depends on informal
                communication, scattered documents, and manual verification
                processes. This creates inefficiencies, misunderstandings, and
                trust barriers.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                GarTexHub was created to solve this problem by combining
                structured communication, verified business identities, and
                secure documentation within one unified system.
              </p>
            </SpotlightCard>
          </MotionItem>
          ...
          <MotionItem index={3} className="lg:col-span-4">
            ...
            >
              <h2 className="text-lg font-bold tracking-tight text-[#1E293B] dark:text-white">
                Mission
              </h2>
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
          ...
          <MotionItem index={6} className="lg:col-span-8">
            ...
            >
              ...
              <p className="mt-4 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                GarTexHub uses a document-based verification system. Companies
                must submit legal and operational documents, which are manually
                reviewed before verification status is granted.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                Verification is subscription-based and must be maintained to
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                    Skeleton loads into audit-ready details -- verified signals
                    stay prominent.
                  </p>
                </div>
          ...
          <MotionItem index={8} className="lg:col-span-5">
            ...
            >
              ...
              <p className="mt-2 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                A global map view that visualizes verified connections between
          ...
          <MotionItem index={9} className="lg:col-span-6">
            ...
            >
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                GarTexHub is strictly dedicated to the Garments and Textile
                sector. By focusing on a single industry, we provide smarter
                categorization, clearer communication, and more relevant
                matching between buyers and manufacturers.
              </p>
            </SpotlightCard>
          </MotionItem>
          ...
          <MotionItem index={10} className="lg:col-span-6">
            ...
            >
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                We do not process direct financial transactions. Our platform is
                designed to facilitate secure communication, structured
                agreements, and verified business interactions.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                GarTexHub operates with the principle that trust is earned
                through transparency, documentation, and professional conduct.
              </p>
            </SpotlightCard>
          </MotionItem>
          ...
          <MotionItem index={11} className="lg:col-span-12">
            ...
            >
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#475569] dark:text-slate-300">
                For partnership inquiries, support, or compliance-related
                questions, please contact us through our official communication
