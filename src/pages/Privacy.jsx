        ...
        >
          <div className="rounded-3xl bg-[#ffffff]/80 backdrop-blur-md shadow-borderless dark:shadow-borderlessDark shadow-[0_10px_40px_rgba(2,6,23,0.06)] p-6 lg:p-8 dark:bg-[#0f172a]/70 dark:shadow-none dark:ring-1 dark:ring-white/10 transition-colors duration-500 ease-in-out">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-bold tracking-[0.18em] uppercase bg-sky-50 text-sky-700 shadow-borderless dark:shadow-borderlessDark dark:bg-white/5 dark:text-sky-200 dark:ring-1 dark:ring-white/10">
                  Legal Documentation
                </div>
