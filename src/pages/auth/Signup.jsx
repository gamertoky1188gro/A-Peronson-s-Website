										...
										<div class="space-y-3">
											<div class="relative">
												<input
													...
													minLength={8}
													maxLength={32}
													class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 pr-20 text-sm outline-none transition placeholder:text-slate-400 focus:border-sky-400 focus:ring-4 focus:ring-sky-500/10 dark:border-white/10 dark:bg-white/5 dark:placeholder:text-slate-500"
													required={true}
												/>
												<button
													type="button"
											...
											{password && (
												<>
													<PasswordStrengthBar password={password} minLength={8} maxLength={32} />
													<PasswordChecklist
														value={password}
