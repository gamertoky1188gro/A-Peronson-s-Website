      ...
      <div className="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-[0_18px_60px_rgba(15,23,42,0.08)] ring-1 ring-slate-200/60 dark:bg-slate-900/70 dark:shadow-none dark:ring-white/10">
        ...
        >
          <div>
            ...
            <input
              className="w-full px-4 py-3 shadow-borderless dark:shadow-borderlessDark rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A66C2]/20 bg-white text-slate-900 dark:bg-[#0b1224] dark:text-slate-100"
              value={form.name}
          ...
          {error ? (
            <p className="md:col-span-2 text-sm text-red-500 dark:text-rose-300">
              {error}
            </p>
          ) : null}
          ...
          <div className="md:col-span-2 flex flex-col gap-3 sm:flex-row sm:items-center">
            <button
              disabled={loading}
              className="px-5 py-3 rounded-lg bg-[#0A66C2] hover:bg-[#004182] text-white disabled:opacity-70"
            >
