										...
										{categories.includes("Other") && (
											<div className="mt-4">
												...
												<input
													...
													maxLength={40}
													className={`w-full rounded-2xl border bg-white px-4 py-3 text-sm outline-none transition placeholder:text-slate-400 focus:shadow-[0_0_0_4px_rgba(14,165,233,0.12)] dark:bg-slate-900/80 dark:placeholder:text-slate-500 ${
														customCategoryError
