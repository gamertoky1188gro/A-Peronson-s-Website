							...
							<div>
								...
								<div className="relative">
									...
									<input
										...
										className={`w-full rounded-2xl border px-10 py-2.5 text-sm outline-none transition focus:ring-4 ${theme.field}`}
							...
							<div>
								...
								<div className="relative">
									...
									<input
										...
										className={`w-full rounded-2xl border px-10 py-2.5 pr-24 text-sm outline-none transition focus:ring-4 ${theme.field}`}
										placeholder="•••••••••••"
									/>
									<button
										type="button"
							...
							<div className="space-y-3 pt-2">
								...
								<div className="grid gap-3 sm:grid-cols-2">
									<button
										...
										className={`inline-flex items-center justify-center gap-2 rounded-2xl border px-5 py-3 text-sm font-semibold transition ${theme.buttonAlt} disabled:opacity-60`}
									>
