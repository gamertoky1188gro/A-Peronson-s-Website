...
const AtSign = (p) => (
  <Icon d="M16 8a4 4 0 1 1-8 0 4 4 0 0 1 8 0zm2 0v6a2 2 0 1 1-4 0V8" {...p} />
);
const BadgeCheck = (p) => (
  <Icon d="M9 12l2 2 4-4M12 22l7-4V6l-7-4-7 4v12l7 4z" {...p} />
);
const Eye = (p) => (
  <Icon
...
const ShieldCheck = (p) => (
  <Icon d="M12 22l7-4V6l-7-4-7 4v12l7 4zm-2-10l2 2 4-4" {...p} />
);
const Sparkles = (p) => (
  <Icon
    ...
    <div className={`min-h-screen overflow-hidden ${theme.page}`}>
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="flex items-center justify-center px-5 py-8 sm:px-8 lg:px-10">
          <div
            className={`relative w-full max-w-xl rounded-[2rem] border p-6 sm:p-8 ${theme.panel}`}
          >
            ...
            <div className="mb-10 flex items-center gap-3">
              <div
                className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${theme.gradient} text-white shadow-lg shadow-sky-500/30`}
              >
                <Sparkles className="h-6 w-6" />
              </div>
              <div>
                <p
                  className={`text-sm font-semibold uppercase tracking-[0.28em] ${theme.soft}`}
                >
                  Vault Access
                </p>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {roles.map((role) => (
                  <div
                    key={role}
                    className={`rounded-2xl border px-4 py-3 ${theme.chip}`}
                  >
              ...
              <div
                className={`rounded-[1.75rem] border p-5 sm:p-6 ${theme.card}`}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`mt-1 text-sm leading-6 ${theme.soft}`}>
                      Fast sign-in, passkey support, and a clean interface
                      designed for premium workflows.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-3">
                  {[
                    ...
                    <div
                      key={title}
                      className={`rounded-2xl border px-4 py-3 ${theme.panel}`}
                    >
        ...
        <section className="flex items-center justify-center px-5 py-8 sm:px-8 lg:px-10">
          <div
            className={`w-full max-w-xl rounded-[2rem] border p-6 sm:p-8 ${theme.card}`}
          >
            ...
            <div className="mb-8">
              <p
                className={`text-sm font-semibold uppercase tracking-[0.3em] ${theme.soft}`}
              >
                Welcome back
              </p>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <AtSign
                    className={`pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 ${theme.soft}`}
                  />
                  <input
                    value={identifier}
