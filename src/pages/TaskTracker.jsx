		...
		<div className="select-none">
			...
			>
				...
				{task.issues && task.issues.length > 0 && (
					<span className="text-xs text-orange-500 ml-auto">{task.issues.length} issues</span>
				)}
			</div>
			...
			<div className="max-w-4xl mx-auto">
				<div className="flex items-center justify-between mb-6">
					<div>
						...
						<p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Task Progress Tracker</p>
					</div>
						...
						{filteredTasks.map((task) => (
							...
							>
								...
								>
									...
									<span className="font-semibold text-lg flex-1">{task.title}</span>
