      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-16 flex-wrap items-center justify-between gap-3 py-2">
          ...
          <div className="flex w-full items-center gap-3 md:w-auto">
            ...
            <div className="ml-auto flex items-center gap-2 sm:gap-3">
              ...
              <Link to="/owner" className="hidden sm:block" aria-label="Owner profile">
                <div className="h-9 w-9 rounded-full bg-gradient-to-br from-sky-500 to-indigo-500 shadow" />
              </Link>
        ...
        {mobileOpen ? (
          <div className="space-y-2 border-t border-slate-200 pb-3 pt-2 md:hidden dark:border-slate-700">
            ...
            <input
              placeholder="Search buyers, factories, products..."
              className="mt-2 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm dark:border-slate-700 dark:bg-slate-900"
            />
          </div>
        ) : null}
      </div>
