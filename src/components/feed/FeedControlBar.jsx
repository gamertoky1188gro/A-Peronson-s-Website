...
export default function FeedControlBar({
  ...
  return (
    <div className="sticky top-[64px] z-10 bg-slate-50/90 backdrop-blur supports-[backdrop-filter]:bg-slate-50/70 borderless-divider-b dark:bg-[#020617]/80 dark:supports-[backdrop-filter]:bg-[#020617]/70 dark:shadow-[inset_0_-1px_0_rgba(255,255,255,0.08)]">
