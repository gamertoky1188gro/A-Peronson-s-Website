...
- **Route definition:** `server/routes/systemRoutes.js:6`
...
- **Route definition:** `server/routes/systemRoutes.js:7`
...
- **Route definition:** `server/routes/systemRoutes.js:8`
...
- **Route definition:** `server/routes/systemRoutes.js:9`
