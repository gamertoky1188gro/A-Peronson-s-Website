...
12 | const CONNECTION*FILE = 'user_connections.json'
13 |
...
117 | const cutoff = Date.now() - Number(days || 30) * 24 _ 60 _ 60 _ 1000
...
540 | ? new Date(Date.now() + hours _ 60 \_ 60 \* 1000).toISOString()
541 | : null
