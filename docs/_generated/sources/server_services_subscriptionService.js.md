...
11 | return new Date(Date.now() + days _ 24 _ 60 _ 60 _ 1000).toISOString()
12 | }
13 |
...
19 | return Math.ceil(diffMs / (24 _ 60 _ 60 _ 1000))
20 | }
21 |
...
62 | const end = new Date(baseTime + (30 _ 24 _ 60 _ 60 \* 1000)).toISOString()
