...
return new Date(Date.now() + days _ 24 _ 60 _ 60 _ 1000).toISOString()
}
...
return Math.ceil(diffMs / (24 _ 60 _ 60 _ 1000))
}
...
const end = new Date(baseTime + (30 _ 24 _ 60 _ 60 \* 1000)).toISOString()
const start = nowIso()
