...
38 | {/_ Centered panel to keep the message readable and focused. _/}
...
47 | {/_ Show the blocked route (fallback to generic wording if missing). _/}
48 | You do not have permission to access <strong>{location.state?.from || 'this page'}</strong>.
49 | </p>
50 | {/_ Primary actions: re-auth or return to a safe default page. \*/}
