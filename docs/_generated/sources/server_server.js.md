...
77 |
78 | const FX*REFRESH_INTERVAL_MS = 60 * 60 _ 1000
...
172 | const JWT*SECRET = process.env.JWT_SECRET || 'mvp-dev-secret'
...
666 | }, 6 * 60 _ 60 _ 1000)
667 |
668 | setInterval(() => {
669 | runLeadReminderSweep().catch((error) => logError('lead*reminder_sweep_failed', error))
670 | }, 5 * 60 \_ 1000)
