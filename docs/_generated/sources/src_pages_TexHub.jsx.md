...
duration: 0.5,
ease: [0.16, 1, 0.3, 1],
// Stagger timing: each card waits`index _ 100ms`.
delay: index _ 0.1,
}}
>
{children}
...
const dx = (relX - 0.5) _ 2
const dy = (relY - 0.5) _ 2
x.set(dx _ maxShift)
y.set(dy _ maxShift)
}
...
short*description: 'A focused B2B platform for Bangladesh-centric but global-facing garments and textile sourcing.',
