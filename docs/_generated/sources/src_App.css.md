...
13 | --border: #cbd5e1;
14 | --accent: #10b981;
15 | /_ GarTex brand primary (locked): LinkedIn-style professional blue _/
16 | --gt-blue: #0a66c2;
...
25 | --border: #374151;
26 | --accent: #10b981;
27 | /_ Keep the same primary blue in dark mode for brand consistency _/
28 | --gt-blue: #0a66c2;
...
42 |
43 | /_ Base polish (utilities can override these) _/
44 | .card,
45 | .bg-white,
46 | .bg-gray-50,
47 | .bg-gray-100,
...
88 | textarea:focus {
89 | outline: none;
90 | /_ Brand-consistent focus ring (blue) _/
...
108 | }
109 |
110 | /_ Shared modern dark styling across every page _/
111 | :root.dark body {
