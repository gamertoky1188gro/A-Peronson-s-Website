...
const DEFAULT*SOURCE_MODULE = 'backend'
const IDEMPOTENCY_TTL_MS = 15 * 60 _ 1000
...
sourceModule: sanitizeString(String(context.sourceModule || base.sourceModule || DEFAULT*SOURCE_MODULE), 80) || DEFAULT_SOURCE_MODULE,
...
const intervalMs = Math.max(60_000, Number(process.env.EVENT_QUALITY_REPORT_INTERVAL_MS || 15 * 60 \_ 1000))
setInterval(() => {
