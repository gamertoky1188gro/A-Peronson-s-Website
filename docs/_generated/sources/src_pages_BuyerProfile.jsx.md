...
43 | if (role === 'buying*house') return `/buying-house/${encodeURIComponent(id)}`
...
339 | >
340 | <div className="relative flex items-center gap-2 px-4 py-3 bg-white/60 dark:bg-slate-950/30 borderless-divider-b dark:shadow-[inset_0*-1px_0_rgba(255,255,255,0.08)]">
...
513 | <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">{r.score}_ -- {r.reviewer_name || 'Anonymous'}</p>
