...
12 | let lastStatus = { last*ok_at: '', last_error_at: '', last_error: '' }
...
54 | return prefix.endsWith('*') ? prefix : `${prefix}_`
55 | }
56 |
...
89 | if (cachedConfig.value && now() - cachedConfig.at < CONFIG*TTL_MS) return cachedConfig.value
...
304 |
305 | const hours = (outboundAt - inboundAt) / (1000 * 60 \_ 60)
