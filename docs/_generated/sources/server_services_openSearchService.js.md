...
let lastStatus = { last*ok_at: '', last_error_at: '', last_error: '' }
...
return prefix.endsWith('*') ? prefix : `${prefix}_`
}
...
if (cachedConfig.value && now() - cachedConfig.at < CONFIG*TTL_MS) return cachedConfig.value
