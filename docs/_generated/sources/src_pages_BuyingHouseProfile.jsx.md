...
36 | if (role === 'buying*house') return `/buying-house/${encodeURIComponent(id)}`
...
337 | >
338 | <div className="relative flex items-center gap-2 px-4 py-3 bg-white/60 dark:bg-slate-950/30 borderless-divider-b dark:shadow-[inset_0*-1px_0_rgba(255,255,255,0.08)]">
