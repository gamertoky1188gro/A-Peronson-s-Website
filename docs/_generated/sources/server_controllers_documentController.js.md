...
23 | try {
24 | const entityType = req.body?.entity*type || 'verification'
...
113 | const retentionMs = Number(process.env.ESIGN_WEBHOOK_NONCE_RETENTION_MS || 24 * 60 _ 60 _ 1000)
114 |
...
119 | try {
120 | logInfo('esign*webhook_received', { contractId: req.params.contractId, hasSignature: Boolean(signatureHeader), hasSecret: Boolean(incomingSecretHeader) })
121 | } catch {
122 | void 0
123 | }
124 |
