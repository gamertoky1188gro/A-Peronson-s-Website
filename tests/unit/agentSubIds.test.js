import { createAgentSubId, listAgentSubIds, getAgentSubIdById, deleteAgentSubId } from '../../server/services/agentSubIdService.js'
...
describe('agent sub-id service', () => {
  ...
  test('create, list, get, delete sub-id', async () => {
    ...
    const row = await createAgentSubId(owner, { label: 'test sub', metadata: { foo: 'bar' } })
